...
(CLOSE_GAP_E_LEAN_LIFT_MEMO (historical development memo),
F3_ANTIDIAGONAL_CANDIDATE_MEMO (historical development memo) — the
...
failure condition (`02_REGISTRY/assumptions.csv`).
...
discipline (ALPHA_SEAM_FORM_FORCED_MEMO (historical development memo)):
