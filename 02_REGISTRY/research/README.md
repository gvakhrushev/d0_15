...
- `SYNTHESIS_A4D_PATH_RESOLVED_MATTER_WORD_ACTION.md` — historical synthesis packet resolved/sharpened by the path-word action memo; it correctly separated path composition from energy-congruence typing.
