...
- `SYNTHESIS_A4D_PATH_RESOLVED_MATTER_WORD_ACTION.md` — active fixed-N synthesis target: test whether one typed matter action on owned path words can unify the H first jet, S second jet, relative holonomy, observer/frame law and fixed-J dualization without importing golden refinement.
