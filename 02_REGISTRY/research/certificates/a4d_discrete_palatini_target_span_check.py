...
print("RESULT_LAMBDA: Vol_eta is typed from owned solder legs + eta-volume, but not in span{S_star,I^eta,I^n}.")
print("RESULT_SPAN_NO_LAMBDA: Palatini + legal T^2 lies in span{S_star, I^eta, I^n}.")
print("RESULT_SPAN_WITH_LAMBDA: Palatini + Lambda + legal T^2 needs the owned Vol_eta channel.")
print("TERMINAL: DISCRETE-PALATINI-TARGET-NEEDS-INVARIANT: Vol_eta")
