...
rru = 4/(4-3*u)
check(
    "227_RATIO_DERIVATIVE_FORM",
    sp.simplify(sp.diff(rru,u) - 12/(4-3*u)**2) == 0,
)
check(
    "227_RATIO_DENOM_POS_ON_INTERVAL",
    4 - 3*sp.Rational(1,16) > 0,
)
check(
    "227_RATIO_ENDPOINT",
    sp.simplify(rru.subs(u,sp.Rational(1,16))) == sp.Rational(64,61),
)
