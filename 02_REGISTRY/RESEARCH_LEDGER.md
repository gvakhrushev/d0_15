...
| A-NORM — finite gravity relative normalization | IN PROGRESS | Quotients the Hodge kinetic coefficient, A1/contact coefficient and two-tick coupling by genuine action/field/Q-alpha/sign/time-orientation redundancies, then tests SceneSpectralAction, S_min=1, finite hbar mechanism, C1 isometry, reciprocity and stability for an internal normalization theorem. | Do not reuse SI/continuum calibration as CORE input. Active task: `EXP-ANORM-FINITE-GRAVITY-NORMALIZATION`. |
