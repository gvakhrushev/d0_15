...
def claimMap : List ClaimMapEntry :=
  [
    ...
    { claimId := "D0-IM-001", moduleName := "D0.IM.SelfSubstrateTrace",
      theoremName := "self_substrate_trace_principle_cert", status := ClaimStatus.pythonCertClosed },
    { claimId := "D0-IM-002", moduleName := "D0.IM.FractalTick",
      theoremName := "fractal_tick_cert", status := ClaimStatus.pythonCertClosed },
    ...
    { claimId := "D0-IM-PRED-001", moduleName := "D0.IM.FractalContinuumPredictions",
      theoremName := "fractal_continuum_predictions_cert", status := ClaimStatus.pythonCertClosed },
