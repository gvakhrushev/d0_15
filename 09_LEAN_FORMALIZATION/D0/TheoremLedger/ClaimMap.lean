...
def claimMap : List ClaimMapEntry :=
  [
    ...
    { claimId := "D0-QUASI009-CKM-PHASON-HOLONOMY-001", moduleName := "D0.Matter.CKMPhasonHolonomy",
      theoremName := "Matter.torus_shell_noncommutator_is_phason_connection_curvature;Matter.phason_parallel_transport_around_shells_is_unitary;Matter.phason_holonomy_response_has_multisupport_row;Matter.phason_holonomy_response_not_permutation;Matter.ckm_cp_phase_is_chiral_phason_bundle_twist;Matter.ckm_matrix_is_phason_holonomy_on_torus_core13", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-QUASI008-PHASON-FLIP-ENTROPY-SDE-001", moduleName := "D0.Cosmology.PhasonFlipEntropy",
      theoremName := "Cosmology.phason_flip_entropy_nonnegative;Cosmology.archive_pressure_is_phason_flip_entropy_osmosis;Cosmology.phason_flip_transfer_matrix_has_sde_polynomial;Cosmology.sde_roots_are_phason_flip_relaxation_modes", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-QUASI007-MESON-PHASON-DOMAIN-WALLS-001", moduleName := "D0.Matter.MesonPhasonDomainWalls",
      theoremName := "Matter.meson_phason_domain_wall_boundary_nonzero;Matter.meson_phason_domain_wall_card_eq_six;Matter.meson_domain_wall_generation_carrier_card_eq_eighteen;Matter.meson_domain_wall_transfer_uses_lifted_defect;Matter.meson_phason_domain_wall_closure", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-KTHEORY-001", moduleName := "D0.Matter.KTheoryGapLabeling",
      theoremName := "Matter.gap_label_is_topological_not_fitted;Matter.d0_gap_labels_are_countable;Matter.gap_labeling_requires_frozen_operator;Matter.meson_domain_wall_spectrum_admits_k0_labels;Matter.ckm_holonomy_spectrum_admits_k0_labels;Matter.archive_pressure_spectrum_admits_k0_labels", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-SOLENOID-001", moduleName := "D0.Geometry.NonCommutativeSolenoid",
      theoremName := "Geometry.d0_hull_admits_noncommutative_solenoid_model", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-SOLENOID-GRAVITY-001", moduleName := "D0.Geometry.NonCommutativeSolenoidGravity",
      theoremName := "Geometry.d0_heat_trace_admits_solenoid_spectral_triple_approx;Geometry.finite_spin2_operator_is_tt_sector_of_solenoid_spectral_geometry;Geometry.wtt4_is_compatible_with_noncommutative_solenoid_geometry", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-MESON-K0-001", moduleName := "D0.Matter.MesonPhasonDomainWalls",
      theoremName := "Matter.lower_hodge_400_is_domain_wall_tension_seed;Matter.meson_domain_wall_fluctuation_operator_has_spectral_gaps;Matter.meson_domain_wall_gaps_have_k0_labels;Matter.k0_labels_permit_meson_spectral_passport", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-CKM-K0-001", moduleName := "D0.Matter.CKMPhasonHolonomy",
      theoremName := "Matter.torus_shell_noncommutator_defines_phason_connection_curvature;Matter.ckm_holonomy_has_k_theory_class;Matter.ckm_cp_phase_is_oriented_noncommutative_area", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-SDE-K0-001", moduleName := "D0.Cosmology.PhasonFlipEntropy",
      theoremName := "Cosmology.sde_relaxation_modes_have_gap_labels;Cosmology.archive_pressure_spectrum_is_gap_labeled", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-FOUND-004", moduleName := "D0.Foundation.QuadraticPeel",
      theoremName := "quadratic_peel_born_holography_cert", status := ClaimStatus.pythonCertClosed },
    ...
    { claimId := "D0-IM-COSMO-001", moduleName := "D0.IM.RelativeArchiveAcceleration",
      theoremName := "relative_archive_acceleration_positive_second_difference", status := ClaimStatus.pythonCertClosed },
