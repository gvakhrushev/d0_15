...
def claimMap : List ClaimMapEntry :=
  [
    ...
    { claimId := "D0-P-SUBCRIT-001", moduleName := "D0.Foundation.M1CoreSaturation",
      theoremName := "subcritical_iff;rate_ge_one_of_three_le;alpha_subcritical_extremality", status := ClaimStatus.leanCoreProved },
