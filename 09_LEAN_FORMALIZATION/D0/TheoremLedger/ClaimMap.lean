...
def claimMap : List ClaimMapEntry :=
  [
    ...
    { claimId := "D0-PHI-QUADPISOT-MINIMALITY-001", moduleName := "D0.NumberTheory.PhiQuadPisotMinimality",
      theoremName := "PHI_QUADPISOT_MINIMALITY_PROVED;quad_pisot_phi_le;quad_pisot_eq_phi_iff;betaOne_quad_pisot;betaOne_one_eq_phi", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-DYAD-COMPLEMENTARITY-001", moduleName := "D0.Core.DyadComplementarity",
      theoremName := "DYAD_COMPLEMENTARITY_PROVED;dyad_complementarity_bound;dyad_bound_eq_iff_det_zero;pathCertain_readout;coherenceMaximal_readout", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-DYAD-FRINGE-BRIDGE-001", moduleName := "D0.Core.DyadFringeBridge",
      theoremName := "DYAD_FRINGE_BRIDGE_PROVED;fringe_contrast_eq_visibility;operational_complementarity;phaseIntensity_bounded;fringe_envelope_closure", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-DYAD-CLOSURE-FORCING-001", moduleName := "D0.Core.DyadClosureForcing",
      theoremName := "DYAD_CLOSURE_FORCING_PROVED;gen_bound_valid_iff;gen_bound_saturable_iff;gen_closure_forced;dyad_state_is_forced_closure", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-TRIAD-COMPLEMENTARITY-001", moduleName := "D0.Core.TriadComplementarity",
      theoremName := "triad_constraint;balancedTriad_saturates;balancedTriad_det_zero", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-DYAD-SUBENSEMBLES-001", moduleName := "D0.Core.DyadSubensembles",
      theoremName := "DYAD_SUBENSEMBLES_PROVED;mix_admissible;eraser_identity;phaseIntensity_mix;cross_nonneg;dyad_qf_nonneg", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-TRIAD-SUFFICIENCY-001", moduleName := "D0.Core.TriadSufficiency",
      theoremName := "TRIAD_MAGNITUDE_CHARACTERIZATION_PROVED;aligned_realization;magnitudes_of_admissible", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-EW-TRANSPORT-SECTORS-001", moduleName := "D0.Core.EWTransportSectors",
      theoremName := "ew_sector_count_value;ew_depth_composition;ew_depth_is_twelve;v11_card", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-TRIAD-PHASE-WINDOW-001", moduleName := "D0.Core.TriadPhaseWindow",
      theoremName := "phase_window;phase_window_mul;aligned_admissible_of_face;detAtPhi;windowK", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-GRAV-EINSTEIN-CLASS-SELECTION-001", moduleName := "D0.Geometry.FiniteBianchiEinsteinTensor",
      theoremName := "ricci_or_scalar_only_not_full_gravity_response;einstein_transform_coupling_eq;scalar_coupling_of_conserved;graded_bianchi_closure", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-MINCUT-A4-ENTROPY-001", moduleName := "D0.Topology.FiniteMinCutEntropy",
      theoremName := "finite_min_cut_exists;cutCapacity;minCutValue;finiteEntanglementEntropy;finite_entanglement_entropy_nonneg", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-WINDOW-9-13-DISSOLVE-001", moduleName := "D0.VNext2.SceneTripleForced",
      theoremName := "scene_triple_from_owned_chain;scene_triple_unique_v2;window_endpoints_derived;unique_lucas_in_derived_window;level_five_minimal_all_parities", status := ClaimStatus.openObligation },
    { claimId := "D0-SCENE-FORCED-CHAIN-001", moduleName := "D0.VNext2.SceneTripleForced",
      theoremName := "scene_triple_from_owned_chain;scene_triple_unique_v2;window_endpoints_derived;unique_lucas_in_derived_window;level_five_minimal_all_parities", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-CASCADE-INTERLOCK-ARROW-001", moduleName := "D0.Foundation.CascadeInterlockArrow",
      theoremName := "equilibrium_class_inhabited;equilibrium_collapses_to_one_test;equilibrium_depth_collapse;repair_breaks_equilibrium;interlock_proofreading_arrow", status := ClaimStatus.leanCoreProved }
  ]
