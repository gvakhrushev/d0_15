...
def claimMap : List ClaimMapEntry :=
  [
    ...
    { claimId := "D0-GRAV-004", moduleName := "D0.Gravity.MeasurementHorizonEquivalence",
      theoremName := "measurement_horizon_equivalence_cert", status := ClaimStatus.pythonCertClosed },
    { claimId := "D0-GRAV-005", moduleName := "D0.Gravity.OpticalJetBackreaction",
      theoremName := "optical_jet_backreaction_cert", status := ClaimStatus.pythonCertClosed },
    ...
    { claimId := "D0-EDGE-RAMIFICATION-001", moduleName := "D0.Edge.RamificationFromUeEffCompanion",
      theoremName := "ramification_companion_cover_cert", status := ClaimStatus.pythonCertClosed },
    { claimId := "D0-BARYON-POLES-001", moduleName := "D0.Matter.BaryonAnonymousPoleSet",
      theoremName := "baryon_anonymous_image_poles_cert", status := ClaimStatus.pythonCertClosed },
    { claimId := "D0-HORIZON-JET-001", moduleName := "D0.Gravity.HorizonJetAndBaryonPole",
      theoremName := "horizon_jet_observable_cert", status := ClaimStatus.pythonCertClosed },
    ...
    { claimId := "D0-IM-COSMO-002", moduleName := "D0.IM.ArchivePressureCoupling",
      theoremName := "relative_pressure_bridge_law", status := ClaimStatus.pythonCertClosed },
    { claimId := "D0-IM-COSMO-003", moduleName := "D0.IM.StrongLogdetPressure",
      theoremName := "strong_logdet_pressure_coupling", status := ClaimStatus.pythonCertClosed },
    { claimId := "D0-IM-COSMO-004", moduleName := "D0.IM.LogdetSecondResponse",
      theoremName := "logdet_second_response_stability_sign_corrected", status := ClaimStatus.pythonCertClosed },
    { claimId := "D0-PUB-001", moduleName := "D0.Publication.MonographStructure",
      theoremName := "release_monograph_structure_audit", status := ClaimStatus.openObligation },
    { claimId := "D0-QUANT-MET-001", moduleName := "D0.Metrology.QuantumLimits",
      theoremName := "quantum_metrology_limits", status := ClaimStatus.pythonCertClosed },
    { claimId := "D0-QUANT-MET-002", moduleName := "D0.Metrology.PSDPurification",
      theoremName := "psd_purification_inequality", status := ClaimStatus.pythonCertClosed },
