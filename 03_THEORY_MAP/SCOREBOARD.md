...
- **Realized strength:** 6941 / 9358 (**74.2%** of track-fair max)
- **Core spine:** 5420 / 7780 (headroom **2360** points to take every core claim to L5)
- Claims: 536 active (538 total); integrity demotions: 0; duplicates: 0

## Repository hygiene / refactor score

- **Hygiene:** 90.3 / 100 (penalties **-9.7**, bonuses **+0.0**) — cleanup *gains* points here; tracked meta-trash / fake proofs / book-clutter *lose* them.
...
| `orphan_proof_targets` | 47 | -4.7 | PROOF-TARGET markers in book prose with no registry row |
...
**Top cleanup actions (most points to regain):** `real_in_project_lake` (-5); `orphan_proof_targets` (-4.7)
...
|---|--:|--:|--:|--:|
| formal_core | 331 | 4655 | 5817 | 1132 |
| frontier | 40 | 130 | 800 | 670 |
...
|---|--:|--:|--:|--:|
| BOOK_04 | 101 | 1285 | 1731 | 426 |
| BOOK_08 | 85 | 1136 | 1540 | 395 |
| BOOK_07 | 68 | 864 | 1162 | 284 |
| BOOK_02 | 64 | 716 | 1023 | 302 |
| BOOK_06 | 42 | 514 | 725 | 206 |
