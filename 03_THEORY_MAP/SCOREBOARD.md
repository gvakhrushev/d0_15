...
- **Realized strength:** 6667 / 9128 (**73.0%** of track-fair max)
- **Core spine:** 5216 / 7640 (headroom **2424** points to take every core claim to L5)
- Claims: 521 active (523 total); integrity demotions: 0; duplicates: 0

## Repository hygiene / refactor score

- **Hygiene:** 100.0 / 100 (penalties **-6.7**, bonuses **+10.0**) — cleanup *gains* points here; tracked meta-trash / fake proofs / book-clutter *lose* them.
...
**Top cleanup actions (most points to regain):** `orphan_proof_targets` (-3.7); `phantom_certs` (-3)
