...
- **Realized strength:** 5142 / 7122 (**72.2%** of track-fair max)
- **Core spine:** 4412 / 6360 (headroom **1948** points to take every core claim to L5)
- Claims: 391 active (393 total); integrity demotions: 0; duplicates: 0

## Repository hygiene / refactor score

- **Hygiene:** 100.0 / 100 (penalties **-4.2**, bonuses **+10.0**) — cleanup *gains* points here; tracked meta-trash / fake proofs / book-clutter *lose* them.
...
**Top cleanup actions (most points to regain):** `orphan_proof_targets` (-4.2)
...
|---|--:|--:|--:|--:|
| BOOK_08 | 75 | 988 | 1404 | 412 |
| BOOK_04 | 74 | 952 | 1358 | 396 |
