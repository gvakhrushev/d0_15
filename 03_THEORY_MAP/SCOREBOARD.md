...
- **Realized strength:** 6667 / 9120 (**73.1%** of track-fair max)
- **Core spine:** 5204 / 7620 (headroom **2416** points to take every core claim to L5)
- Claims: 521 active (523 total); integrity demotions: 0; duplicates: 0

## Repository hygiene / refactor score

- **Hygiene:** 100.0 / 100 (penalties **-6.8**, bonuses **+10.0**) — cleanup *gains* points here; tracked meta-trash / fake proofs / book-clutter *lose* them.
...
**Top cleanup actions (most points to regain):** `orphan_proof_targets` (-3.8); `phantom_certs` (-3)
...
| frontier | 46 | 152 | 920 | 768 |
| cosmology | 50 | 753 | 931 | 178 |
| smooth_geometry | 37 | 445 | 614 | 165 |
