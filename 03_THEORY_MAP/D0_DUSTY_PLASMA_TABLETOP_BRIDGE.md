# D0_DUSTY_PLASMA_TABLETOP_BRIDGE
...
```text
D0_DUSTY_PLASMA_TABLETOP_BRIDGE = ACTIVE-LAB-BRIDGE
D0_DUSTY_PLASMA_TABLETOP_ISOMORPHISM = NOT-CLOSED
D0_TABLETOP_QG_PROOF = FORBIDDEN-CLAIM
```
## 10. Proofread note
