...
|---|---|---:|---|---|
| electron full cycle | section dictionary | `О›_act=38 m_e c^2` | SI unit section | yes, section only |
...
| `m_Ој/m_e` | lepton generation readout | `206.769987111730` | PDG mass comparison | no |
| scalar amplitude | survey comparison protocol | `2.0553825512209827Г—10^-9` | CLASS/CAMB likelihood | no |
...
```text
proof object
в†’ finite/profinite construction
в†’ executable certificate
в†’ external numerical comparison protocol
```
