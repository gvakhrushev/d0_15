...
certificates below; the only residual is the continuum-limit step, held honestly at LEM.
...
**Status LEM (honest).** The mechanism is written and finite-certified: D0 *generates* a
...
exists, "QFT = shadow of the D0 automaton" is a strong LEM, cited not over-claimed.
