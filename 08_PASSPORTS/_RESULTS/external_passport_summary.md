...
| DESI/BAO S_DE real-data hard run | DESI_DR2_BAO | 08_PASSPORTS/DESI/desi_dr2_manifest.json | (see manifest) | Frozen S_DE (λ_c=1.420943, λ_r=1.579057, no refit) | ΛCDM published + flat residual | delta_chi2, rmse on sample bins | FAIL_DESI_BAO_SDE_REAL_DATA | Sample data used for demo; full official DESI DR2 + cov required for production. delta_chi2=463 (demo). Negative controls passed (no refit). |
