...
| DESI/BAO S_DE real-data hard run | DESI_DR2_BAO | 08_PASSPORTS/DESI/desi_dr2_manifest.json | (see manifest) | Frozen S_DE (λ_c=1.420943, λ_r=1.579057, no refit) | ΛCDM published + flat residual | delta_chi2, rmse on sample bins | PASS_DESI_BAO_SDE_PIPELINE_DEMO (physical: SKIP_DESI_BAO_OFFICIAL_DATA_REQUIRED) | Pipeline demo on sample data. Official DESI DR2 BAO compressed data + covariance required for physical PASS/FAIL. No refit performed. |
