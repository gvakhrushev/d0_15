...
Python certificates: `04_CERTIFICATES/vp_yukawa_shell_overlap_matrix.py`,
`04_CERTIFICATES/vp_higgs_phason_condensation_owner.py`, `04_CERTIFICATES/vp_lepton_yukawa_hierarchy_owner.py`.
