...
Python certificates: `04_CERTIFICATES/vp_lepton_green_puiseux_operator.py`,
`04_CERTIFICATES/vp_lepton_sturmian_puiseux_coefficients.py`, `04_CERTIFICATES/vp_lepton_puiseux_decimal_section.py`.
