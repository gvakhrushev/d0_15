...
Python certificates: `04_CERTIFICATES/vp_connectivity_threshold_owner.py`,
`04_CERTIFICATES/vp_reheating_percolation_owner.py`, `04_CERTIFICATES/vp_cmb_phason_spectrum_owner.py`,
`04_CERTIFICATES/vp_inflationless_early_universe_owner.py`.
