...
Python certificates: `04_CERTIFICATES/vp_alpha_feshbach_residue_finite_sum.py`,
`04_CERTIFICATES/vp_alpha_feshbach_dixmier_owner.py`, `04_CERTIFICATES/vp_neutrino_delta_alpha_norm_square.py`.
