...
def claimMap : List ClaimMapEntry :=
  [
    ...
    { claimId := "D0-ARCHIVE-HODGE-DIRAC-ZERO-MODE-POLLUTION-NOGO-001", moduleName := "D0.Geometry.ArchiveHodgeDiracZeroModePollutionNoGo",
      theoremName := "hodge_kernel_at_two;hodge_kernel_pollution_divergence;archive_hodge_dirac_zero_mode_pollution_nogo_owner", status := ClaimStatus.leanNoGoProved },
