...
def claimMap : List ClaimMapEntry :=
  [
    ...
    { claimId := "D0-ARCHIVE-CAR-DIRAC-OWNER-001", moduleName := "D0.Geometry.ArchiveCARDirac",
      theoremName := "dirac_derivative_scale_eq_fibers;archive_car_dirac_owner", status := ClaimStatus.openObligation },
    ...
    { claimId := "D0-ARCHIVE-CAR-PARITY-SPECTRUM-001", moduleName := "D0.Geometry.ArchiveCARDirac",
      theoremName := "fock_parity_dimension_split;archive_car_parity_spectrum_owner", status := ClaimStatus.openObligation },
