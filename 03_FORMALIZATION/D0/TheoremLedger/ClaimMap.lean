-- AUTO-GENERATED from 02_REGISTRY/claims.csv by tools/generate_lean_views.py.
...
def claimMap : List ClaimMapEntry :=
  [
    { claimId := "D0-DENSE-OPERATOR-SCENE-RIGIDITY-001", moduleName := "D0.Synthesis.DenseOperatorSceneRigidity",
      theoremName := "dense_passport_triangle;dense_passport_no_isolates;dense_operator_recovers_scene;recoveredGraphIso;scene_passport_inhabited", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-TOP-HODGE-INVERSE-SPECTRAL-RIGIDITY-001", moduleName := "D0.Synthesis.TopHodgeInverseSpectralRigidity",
      theoremName := "zoneRootPolynomial_vieta;zoneRootPolynomial_roots;unordered_nat_triple_eq_of_VET_eq;equal_topHodge_data_force_equal_VET;topHodge_inverse_spectral_rigidity;topHodge_data_do_not_choose_zone_labels;without_H_inverse_rigidity_fails;without_M2_inverse_rigidity_fails;without_D_inverse_rigidity_fails;topHodge_inverse_spectral_rigidity_synthesis", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-INTRINSIC-QUOTIENT-RECONSTRUCTION-001", moduleName := "D0.Synthesis.IntrinsicQuotientReconstruction",
      theoremName := "full_degree_spectral_blocks;intrinsicFibreMass_values;intrinsicRestriction_indicator;intrinsicQuotientProjector_eq_reynolds;intrinsicQuotientProjector_certificate;reconstructedAdjacency_eq_AWq;reconstructedDegree_eq_DWq;reconstructedTransport_eq_zoneTransport;reconstructedNormalizedLaplacian_eq_quotient;fullTransport_intrinsic_factorization;fullNormalizedLaplacian_intrinsic_decomposition;intrinsicArchive_eigenvalue_one;intrinsic_quotient_reconstruction", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-AUTOMORPHISM-HODGE-SDE-DECOMPOSITION-001", moduleName := "D0.Synthesis.AutomorphismHodgeSDEDecomposition",
      theoremName := "indicator_zoneAverage_eq_reynolds;full_graph_fixed_algebra_is_degree_generated;full_three_projectors;full_projector_traces;fullActiveRetraction_embedding;fullActiveEmbedding_retraction;fullNormalizedLaplacian_reynolds_decomposition;archive_eigenvalue_one;stationary_eigenvalue_zero;full_active_sde_intertwining;fullNormalizedLaplacian_archive_sde_factorization;topHodge_forces_full_active_characteristic;automorphism_hodge_sde_decomposition", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-COMPLETE-TRIPARTITE-LAPLACIAN-COFACTOR-BRIDGE-001", moduleName := "D0.Synthesis.CompleteTripartiteMatrixTreeBridge",
      theoremName := "graphLaplacianCofactor_eq_explicit;explicitReducedLaplacian_factorization;compressedCofactorMatrix_owner;compressedCofactorMatrix_det;reducedDegreeDiagonal_det;graphLaplacianCofactor_det;topHodge_graphLaplacianCofactor_bridge", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-TOP-HODGE-NORMALIZED-QUOTIENT-SPECTRUM-001", moduleName := "D0.Synthesis.TopHodgeNormalizedQuotientSpectrum",
      theoremName := "VE_sub_T_eq_degreeProduct;normalizedQuotientLaplacian_charpoly;topHodge_data_recovers_VET;topHodge_data_determines_normalized_charpoly;scene_activeProductFromTopHodgeData;scene_normalized_charpoly_eq_x_mul_ownedSDE;harmonic_multiplicity_load_bearing_for_active_product;active_polynomial_does_not_choose_coordinates;topHodge_normalized_quotient_spectral_synthesis", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-TOP-HODGE-KIRCHHOFF-STATIONARY-BRIDGE-001", moduleName := "D0.Synthesis.TopHodgeKirchhoffStationaryBridge",
      theoremName := "topHodgePositivePseudoDet_basis_owner;topHodgePositivePseudoDet_formula;principalMinorSum2_trace_formula;genericStationaryWeight_stationary;normalizedActivePseudoDet_formula;normalizedActivePseudoDet_degree_bridge;topHodge_stationary_pseudodeterminant_bridge;scene_literal_laplacian_descends_to_generic;scene_normalizedActivePseudoDet_eq_sde_det;scene_topHodge_sde_stationary_bridge;normalization_scale_destructive_control;topHodge_kirchhoff_stationary_bridge", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-INTRINSIC-DEGREE-FIBRE-FRAME-001", moduleName := "D0.Synthesis.IntrinsicDegreeFibreFrame",
      theoremName := "intrinsicDegreeOp_eq_DWq;intrinsicDegreeOp_eq_typedDegreeOp;intrinsic_degree_commutant_diagonal;intrinsic_fibre_projectors;intrinsicDegreeOp_spectral_reconstruction;q8_terminal_ranks_own_typed_tags;q8_pairing_not_fixed_by_unpaired_frame;intrinsic_frame_is_signature_blind;intrinsic_frame_with_residual_signature", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-PHASON-ACTIVE-SCENE-CONJUGACY-001", moduleName := "D0.Synthesis.PhasonActiveSceneConjugacy",
      theoremName := "stationaryWeight_mul_sceneTransport;normalized_scene_sde_intertwining;activeRetraction_mul_activeEmbedding;activeEmbedding_mul_activeRetraction;normalizedSceneLaplacian_factorization;sdeTransfer_factorization;activeProjector_polynomial;mem_activeEmbedding_image_iff;active_scene_sde_conjugacy;active_intertwiner_coordinate_nonunique;unnormalized_cubic_intertwiner_still_zero", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-SCENE-NORMALIZED-QUOTIENT-DESCENT-001", moduleName := "D0.Synthesis.SceneNormalizedQuotientDescent",
      theoremName := "adjacency_indicator_intertwining;induced_adjacency_unique;equal_fullDegree_iff_same_zone;zoneTransport_eq_DWinv_mul_AWq;fullTransport_indicator_intertwining;full_laplacian_indicator_intertwining;fullStationaryWeight_indicator;zoneTransport_detailed_balance;scene_normalized_quotient_descent", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-TOP-HODGE-SPECTRAL-SCENE-RECONSTRUCTION-001", moduleName := "D0.Synthesis.TopHodgeSpectralSceneReconstruction",
      theoremName := "topHodgeHarmonicMultiplicity_formula;topHodgeSecondMoment_formula;topHodge_spectral_data_recovers_VET;reduced_scene_six_permutations;reconstruct_scene_unordered_from_topHodge_spectral_data;harmonic_multiplicity_is_load_bearing", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-SDE-CUBIC-SPECTRAL-DISJOINTNESS-001", moduleName := "D0.Synthesis.SDECubicSpectralDisjointness",
      theoremName := "scalar_bezout_certificate;operator_bezout_certificate;no_common_annihilated_vector;no_nonzero_intertwiner;owned_sde_transfer_annihilated;owned_scene_quotient_annihilated;concrete_owned_intertwiner_is_zero", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-SCENE-TOP-HOMOLOGY-ORIENTATION-TRIVIAL-001", moduleName := "D0.Topology.SceneTopHomologyOrientation",
      theoremName := "topHomologyAction_coe;topHomologyActionMatrix_eq_tensor;topHomologyActionMatrix_det;scene_topHomologyAction_det_one;octahedral_topHomology_swap_det_neg_one", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-SCENE-DEGREE-INVARIANT-ALGEBRA-001", moduleName := "D0.Foundation.InvariantAlgebraDegree",
      theoremName := "graphAut_preserves_degree;graphAutInvariant_constant_on_degree_fibers;graphAut_invariant_eq_interpolation;quadratic_representation_unique;degree_generates_full_invariant_algebra;two_degree_values_do_not_force_unique_quadratic", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-EQUIVARIANT-M1-001", moduleName := "D0.Foundation.EquivariantM1",
      theoremName := "m1_forced_is_fixed_under_symmetry;no_m1_forced_of_pointwise_movable;forcing_moved_point_breaks_symmetry", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-M1-HOMOLOGICAL-SCENE-READING-001", moduleName := "D0.Synthesis.M1HomologicalSceneReading",
      theoremName := "homological_scene_m1_forced;vertex_count_alone_not_m1_forced;beta2_alone_not_m1_forced;no_invariant_m1_forced_scene_vertex;m1_homological_scene_reading", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-SCENE-COUNT-REDUCTION-001", moduleName := "D0.Foundation.SceneCountReduction",
      theoremName := "exact_zone_count_of_interpretations", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-REPEATED-ZONE-M1-NOGO-001", moduleName := "D0.Tower.NoExtensionBoundary",
      theoremName := "repeated_zone_type_not_m1_forced", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-DEGREE2-VALUE-EXHAUSTION-NOGO-001", moduleName := "D0.Tower.NoExtensionBoundary",
      theoremName := "degree_two_reduction_does_not_bound_value_count", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-GAP-W-COPY-CAP-M1-001", moduleName := "D0.Core.WitnessForcing",
      theoremName := "card_base_forced_from_m1_copy_invariance", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-ARCHIVE-LAPLACIAN-PHASE-NATURALITY", moduleName := "D0.Geometry.ArchiveLaplacianPhaseNaturality",
      theoremName := "phase_local_quadratic_form_unique;archive_phase_local_laplacian_uniqueness_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-PHASE-CURVATURE", moduleName := "D0.Geometry.ArchivePhaseCurvatureObstruction",
      theoremName := "phase_flat_iff_zero_curvature_obstruction;phase_projection_not_flat;phase_curvature_obstruction_nonzero;archive_phase_laplacian_not_projectively_compatible;archive_phase_curvature_obstruction_owner", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-SRC-NOGO-001", moduleName := "D0.Matter.NuclearShellContactSRC",
      theoremName := "Matter.mass_number_alone_cannot_determine_src_contact;Matter.neutron_excess_alone_cannot_determine_src_contact", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-CVFT-F1", moduleName := "D0.Spectral.DeltaAlphaResidueBlocked",
      theoremName := "delta_alpha_residue_route_blocked", status := ClaimStatus.leanNoGoProved },
    ...
    { claimId := "D0-CVFT-F6", moduleName := "D0.VNext2.GaugeBoundaryCommutator",
      theoremName := "commutator_eq_offblocks;offblock_qgp;zone_preserving_zero_commutator", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-CVFT-F7", moduleName := "D0.CVFT.BoundaryRankLocalization",
      theoremName := "cvft_rank_F_le_dim_boundary", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-HORIZON-JET-001", moduleName := "D0.Gravity.HorizonJetAndBaryonPole",
      theoremName := "horizon_jet_observable_cert", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-IM-PRED-001", moduleName := "D0.IM.FractalContinuumPredictions",
      theoremName := "fractal_continuum_predictions_cert", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-HODGE-001", moduleName := "D0.Topology.BoundaryBoundary;D0.Topology.FiniteCochainNoAxion;D0.Geometry.SceneCochainComplex;D0.Geometry.SceneHodgeDecomposition",
      theoremName := "boundary_boundary_zero;finite_d_d_zero;scene_carrier_cardinalities;scene_d1_d0_zero;scene_boundary_ranks;scene_cochain_exact;adjoint_identity_01;adjoint_identity_12;codifferential_nilpotency;exact_coexact_orthogonal;scene_first_homology_zero;scene_hodge_identities_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-SPIN2-001", moduleName := "D0.Claims.Spin2TT",
      theoremName := "finite_spin2_dof", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-SPECTRAL-EINSTEIN-001", moduleName := "D0.VNext2.SpectralEinsteinResponse",
      theoremName := "einstein_response_symmetric_and_conserved;einstein_response_eq", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-EW-002", moduleName := "D0.VNext2.HiggsAnchorProjector",
      theoremName := "defect_norm_eq_delta0;delta0_eq_phi", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-WINDOW44-TOTIENT-M1-001", moduleName := "D0.VNext2.Window44Totient",
      theoremName := "totient_eq_terminal_degree;units_zmod44_card", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-TOWER-STOP-NOEXT-001", moduleName := "D0.Tower.NoExtension;D0.Tower.NoExtensionBoundary",
      theoremName := "no_extension_theorem;repeated_zone_type_not_m1_forced;degree_two_reduction_does_not_bound_value_count", status := ClaimStatus.openObligation },
    ...
    { claimId := "D0-RANK3-METRIC-TRANSPORT-001", moduleName := "D0.VNext2.Rank3MetricSignature",
      theoremName := "signature_one_plus_two_minus;equal_zone_discriminant_zero", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-M1-CLASS-ADMISSIBILITY-001", moduleName := "D0.Foundation.M1ClassAdmissibility",
      theoremName := "admissible_under_catalogue_map;constant_catalogue_admissible;m1ForcedCarrierEquivPUnit;m1ForcedCarrier_card_one;non_singleton_class_not_M1Forced;class_with_two_witnesses_not_M1Forced;m1_class_admissibility_boundary", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-PHASON-WZ-TRANSFER-OWNER-001", moduleName := "D0.Extensions.ArchiveCommonSectorConstruction",
      theoremName := "sde_window_root_not_archive_eigenvalue", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-PHASON-WZ-FINITE-SEQUENCE-SCAFFOLD-001", moduleName := "D0.VNext2.PhasonWZSequence",
      theoremName := "w_strictly_decreasing;w_excess_form;w_gt_limit", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-TORAL-TIME-MARKOV-CONJUGACY-001", moduleName := "D0.Dynamics.ToralSFTConjugacyNoGo",
      theoremName := "torus_not_homeomorphic_goldenSFT;toral_golden_trace_mismatch;toral_sft_topological_conjugacy_nogo", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-ADLER-WEISS-INTERNAL-CONSTRUCTION-001", moduleName := "D0.VNext2.AdlerWeissInternalMarkov",
      theoremName := "conjugacy_T_negMphi;det_T", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-CKM-CLASS5-PARITY-EXCLUSION-001", moduleName := "D0.Matter.CKMClass5ParityExclusion",
      theoremName := "ckm_class5_parity_exclusion_status", status := ClaimStatus.leanNoGoProved },
    ...
    { claimId := "D0-VNEXT-DIRAC-LAPLACIAN-COMPATIBILITY-OWNER-001", moduleName := "D0.VNext.AFD0LaplacianComparisonNoGo",
      theoremName := "laplacian_tower_compatibility_no_go;laplacian_tower_compatibility_no_go_total;af_skips_d0_dim_total", status := ClaimStatus.leanNoGoProved },
    ...
    { claimId := "D0-VNEXT-33-SCENE-ANCHOR-OWNER-001", moduleName := "D0.VNext.AFSceneAnchorDimensionAudit",
      theoremName := "typed_audit_not_numerology", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-VNEXT-AF-D0-SPECTRAL-COMPRESSION-OWNER-001", moduleName := "D0.VNext.AFD0SpectralInvariantComparison",
      theoremName := "spectral_invariant_obstruction", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-ALPHA-LOG-CESARO-MEASURABILITY-NOGO-001", moduleName := "D0.Spectral.AlphaLogCesaroMeasurability",
      theoremName := "alpha_log_cesaro_ne_mu2", status := ClaimStatus.leanNoGoProved },
    ...
    { claimId := "D0-POSTCORE-HISTORY-REFINEMENT-MAXIMALITY-NOGO-001", moduleName := "D0.Extensions.SceneHistoryRefinementExtension",
      theoremName := "history_refinement_nogo", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-LEPTON-BRANCH-FIXING-OPERATOR-OWNER-001", moduleName := "D0.Extensions.LeptonBranchFixingNoGo",
      theoremName := "lepton_branch_fixing_operator_nogo", status := ClaimStatus.leanNoGoProved },
    ...
    { claimId := "D0-EDGE-COVER-FAMILY-001", moduleName := "D0.Integration.V15.EdgeAudit",
      theoremName := "edge_cover_is_family", status := ClaimStatus.leanNoGoProved },
    ...
    { claimId := "D0-ALPHA-HOLONOMY-LINEAR-FORM-001", moduleName := "D0.Spectral.SeamTransportLinear",
      theoremName := "transport_add;transport_readout;alpha_dressing_factor", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-SCENE-TRIPLE-UNIQUE-001", moduleName := "D0.VNext2.SceneTripleUnique",
      theoremName := "scene_triple_unique", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-RANK3-CUBIC-SYMMETRIC-FUNCTIONS-001", moduleName := "D0.VNext2.Rank3CubicSymmetricFunctions",
      theoremName := "cubic_coefficients;discriminant_positive;det_is_twice_product", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-CONDENSED-GOLDEN-WEIGHT-ANCHOR-001", moduleName := "D0.CondensedAnchor.DetectorSupportGoldenWeight",
      theoremName := "inv_gold_closure;cylWeight_refine;level_one_mass;non_golden_control;cylWeight_return;cylWeight_direct;cylWeight_eq_pow;cylWeight_mem_gap_module;readout_factors_through_finite_level", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-TORUS-SHELL-ATTACHMENT-001", moduleName := "D0.Geometry.TorusShellAttachment",
      theoremName := "torusShellEquivShell3;torusShell_degree_law;torusShell_zoneSize_ladder;torusShell_radius_strictMono;torusShell_inner_unit", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-LEPTON-WITNESS-BRANCH-001", moduleName := "D0.TasksCenterAttack.LeptonWitnessBranchConstruction",
      theoremName := "exists_unique_fixed_point;orbit_count_three;orbit_sizes_pairwise_distinct;order_exactly_twelve;numBranches_eq_numGenerations;exists_branch_gen_bijection", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-GATE-STATIONARITY-OWNER-001", moduleName := "D0.Topology.ArchiveShiftTopology",
    ...
    { claimId := "D0-SCENE-DIM-EVEN-FIBONACCI-FORCING-001", moduleName := "D0.VNext2.SceneDimEvenFibonacci",
      theoremName := "scene_dim_even_fibonacci_forcing", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-SCENE-LAPLACIAN-SPECTRUM-FORCED-001", moduleName := "D0.VNext2.SceneLaplacianSpectrumForced",
      theoremName := "eigenvalue_multiplicities", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-P-M1-SATURATION-001", moduleName := "D0.Foundation.M1CoreSaturation",
      theoremName := "m1_core_saturation;colour_rigidity_extremality;m1Frame_unique_joint_min;alpha_subcritical_extremality;r1_maximal_commutant;higgs_maximal_abelian", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-P-SUBCRIT-001", moduleName := "D0.Foundation.M1CoreSaturation;D0.Spectral.SubcriticalTraceClass",
      theoremName := "subcritical_iff;rate_ge_one_of_three_le;alpha_subcritical_extremality;summable_iff_subcritical;not_summable_at_wall;core_carrier_object", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-P-ABELIAN-001", moduleName := "D0.Foundation.M1CoreSaturation",
      theoremName := "commute_T_core_characterization;higgs_maximal_abelian", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-GAP-E-PORT-EXHAUSTION-001", moduleName := "D0.Tower.PortPowerExhaustion",
      theoremName := "port_power_exhaustion", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-DETECTION-SCENE-BOUND-EQUIVALENCE-001", moduleName := "D0.Synthesis.DetectionSceneBoundEquivalence",
      theoremName := "zone13Bound_iff_capabilityCount_le_two;zone13Bound_iff_primitiveCount_le_two;two_capabilities_seal_zone13;three_capabilities_reopen_zone17;third_port_alphabet_and_zone;three_capability_primitive_count;history_realizes_third_atom;history_outside_current_data_detector;current_data_detector_excludes_history;history_capability_reopens_gap_e;detection_scene_bound_equivalence", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-DETECTOR-CATALOGUE-FREEDOM-001", moduleName := "D0.Synthesis.DetectorCatalogueFreedom",
      theoremName := "liftCat_catalogueFree;catalogueFree_factors;catalogueFree_iff_bare;order_not_catalogueFree;order_requires_external_catalogue;detectorAdmissible_factors;order_not_detectorAdmissible;detector_catalogue_freedom", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-DETECTOR-M1-PREDICATE-BOUNDARY-001", moduleName := "D0.Synthesis.DetectorM1PredicateBoundary",
      theoremName := "falseDetector_catalogueFree;trueDetector_catalogueFree;falseDetector_ne_trueDetector;no_M1Forced_catalogueFree;order_requires_catalogue_relative_to_constraint;canonical_M1_reductio_unavailable;detector_M1_predicate_boundary", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-DETECTOR-LAYER-EQUIVALENCE-001", moduleName := "D0.Synthesis.DetectorLayerEquivalence",
      theoremName := "bareEquivCatalogueFree;currentEquivHistoryInvariant;catalogueFreeEquivHistoryInvariant;catalogueFreeEquivHistoryInvariant_bare;membership_value_in_detector_layer;history_outside_detector_layer;detector_layer_equivalence", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-TYPED-DETECTOR-PRIMITIVE-EXHAUSTION-001", moduleName := "D0.Synthesis.TypedDetectorPrimitiveExhaustion",
      theoremName := "primitive_historyBlind_classification;membershipDetectorProfile_val;valueDetectorProfile_val;atomicOf_one_ne_zero;membershipDetectorProfile_ne_valueDetectorProfile;detectorProfileToFin2_membership;detectorProfileToFin2_value;fin2ToDetectorProfile_zero;fin2ToDetectorProfile_one;fin2ToDetectorProfile_detectorProfileToFin2;detectorProfileToFin2_fin2ToDetectorProfile;detectorPrimitiveProfileEquivFin2;detectorPrimitiveProfile_card;currentData_primitive_profile_exhaustion;history_not_detector_profile;typed_detector_seals_zone13;typed_detector_primitive_exhaustion", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-DETECTOR-M1-CLASS-REPRESENTATION-001", moduleName := "D0.Synthesis.DetectorM1ClassRepresentation",
      theoremName := "detectorClassAdmissible_iff_catalogueFree;toCatalogueFreeCarrier;admissiblePhysicalEmbeddingCatalogueFree;admissiblePhysicalEmbeddingDetectorLayer;concreteComparisonOfDetectorLayer_factors;physicalConcreteComparison_factors;physical_primitive_profile_exhaustion;canonical_representation_non_singleton;detector_M1_class_representation", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-CONCRETE-PHYSICAL-DETECTOR-REPRESENTATION-001", moduleName := "D0.Synthesis.ConcretePhysicalDetectorRepresentation",
      theoremName := "concreteClassM1_iff_historyInvariant;concretePhysicalRepresentation;concreteClassEmbedding;concreteDetectorLayerEmbedding;factorsBoth_iff_historyInvariant;concrete_admissible_factors_both;concrete_admissible_factors_current;concrete_primitive_profile_exhaustion;concrete_controls;concrete_physical_detector_representation", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-P-DEGREE2-EXHAUSTION-001", moduleName := "D0.Tower.NoExtension;D0.Tower.DetectionQuadratic;D0.Tower.NoExtensionBoundary",
      theoremName := "no_extension_theorem;detection_quadratic;degree_two_reduction_does_not_bound_value_count", status := ClaimStatus.openObligation },
    { claimId := "D0-M1-UNIVERSALITY-001", moduleName := "D0.Foundation.M1Universality",
      theoremName := "m1_grammar_functorial;witness_not_manufactured;toy_transport;nc1_transport_fails_without_reflection;nc2_witness_manufactured_without_preservation", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-GRADING-MINIMAL-COMPLETION-SELECTION-001", moduleName := "D0.Extensions.GradingMinimalCompletion",
      theoremName := "grading_minimal_completion_selection;grading_axis_exhaustive;nc_floor;min_attained_iff;minimizers_flip_pair;saturation_surplus", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-COMPLETION-RESIDUAL-COLLAPSE-001", moduleName := "D0.Representation.CompletionResidualCollapse",
      theoremName := "completion_residual_collapse;completion_nc_dichotomy;nc_flip_invariant;nc_eq_iff_flip_class_sig;nc_eq_iff_flip_class;fs_orientation_selects;ncCount_defs_agree;completion_cases", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-AF-REDUCTION-EXHAUSTION-001", moduleName := "D0.VNext.AFReductionExhaustion",
      theoremName := "af_reduction_exhaustion;two_block_dim33_unique;scene_parts_avoid_su_lattice;no_su_reduction_matches_scene;reduction_parts_witness;reduction_parts_witness_owned;reduction_parts_tower_levels", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-BORN-AREA-PRESERVATION-INSUFFICIENT-NOGO-001", moduleName := "D0.Core.BornAreaPreservationNoGo",
      theoremName := "area_preservation_insufficient", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-PHI-HURWITZ-CLASS-CANONIZATION-001", moduleName := "D0.NumberTheory.HurwitzClassCanonization",
      theoremName := "hurwitz_class_canonization", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-JONES-SLOT-SELECTOR-001", moduleName := "D0.NumberTheory.JonesSlotSelector",
      theoremName := "jones_slot_selector", status := ClaimStatus.leanBridgeAssumptionsExplicit },
    { claimId := "D0-ADMISSIBLE-COMPARISON-GRAMMAR-BOUNDARY-001", moduleName := "D0.Foundation.AdmissibleComparisonGrammar",
      theoremName := "operational_exhaustion_three;atomicComparisonEquiv;primitive_iff_atomic;primitive_comparison_exhaustion;admissible_comparison_grammar_boundary", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-PHYSICAL-COMPARISON-REPRESENTATION-REDUCTION-001", moduleName := "D0.Foundation.PhysicalComparisonRepresentation",
      theoremName := "physicalDecomposable_iff_rawDecomposable;physicalPrimitive_iff_rawPrimitive;physicalPrimitiveEmbedding;physicalPrimitive_card_le_two;physicalPrimitive_card_eq_two;rawRepresentation_primitive_count_two;duplicatedCapability_not_injective;hybridOnly_omits_membership_component;physical_comparison_representation_reduction", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-GENERAL-COMPARISON-CAPABILITY-COUNT-001", moduleName := "D0.Foundation.GeneralComparisonGrammar",
      theoremName := "primitive_iff_atomic;primitiveEquivFin;primitive_card_eq;two_capabilities_two_primitives;three_capabilities_three_primitives;general_comparison_capability_count", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-DETECTION-CAPABILITY-THIRD-HISTORY-NOGO-001", moduleName := "D0.Foundation.DetectionCapabilityBoundary",
      theoremName := "membership_capability_vector;value_capability_vector;history_capability_vector;history_is_third_primitive;history_not_determined_by_membership_value;no_membership_value_representation_of_history;current_data_factorization_excludes_history;detection_capability_third_history_boundary", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-CURRENT-DATA-FACTORIZATION-001", moduleName := "D0.Foundation.CurrentDataFactorization",
    ...
    { claimId := "D0-CASCADE-FLOOR-ONE-LOOP-001", moduleName := "D0.Foundation.CascadeFloorOneLoop",
      theoremName := "cascade_floor_one_loop", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-CASCADE-FLOOR-ORDER-MEMORY-001", moduleName := "D0.Foundation.CascadeFloorOrderMemory",
      theoremName := "cascade_floor_order_memory", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-CASCADE-CHAIN-SCAFFOLD-001", moduleName := "D0.Foundation.CascadeChain",
      theoremName := "cascade_chain_scaffold", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-CASCADE-FLOOR-COMPARISON-001", moduleName := "D0.Foundation.CascadeFloorComparison",
      theoremName := "cascade_floor_comparison", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-TRIPARTITE-SIGNATURE-GENERAL-001", moduleName := "D0.Combinatorics.TripartiteSignatureGeneral",
      theoremName := "tripartite_signature_general", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-CASCADE-FLOOR-SCALE-RATIO-001", moduleName := "D0.Foundation.CascadeFloorScaleRatio",
      theoremName := "cascade_floor_scale_ratio", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-MULTIPARTITE-LORENTZIAN-001", moduleName := "D0.Combinatorics.MultipartiteLorentzian",
      theoremName := "multipartite_lorentzian", status := ClaimStatus.leanBridgeAssumptionsExplicit },
    { claimId := "D0-SCENE-DARK-ARCHIVE-STRUCTURE-001", moduleName := "D0.Spectral.DarkArchiveStructure",
      theoremName := "balanced_mem_ker;ker_imp_balanced;no_invariant_vector_in_archive", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-SCENE-JOINT-COMMUTANT-SIX-001", moduleName := "D0.Spectral.JointCommutant",
      theoremName := "joint_commutant;no_rational_root", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-EQUIVARIANT-SEAM-NOGO-001", moduleName := "D0.Synthesis.EquivariantSeamNoGo",
      theoremName := "no_equivariant_seam;archive_invariant;visible_invariant", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-TRANSPORT-CLOSED-FORM-001", moduleName := "D0.Spectral.TransportClosedForm;D0.Spectral.TransportSelfAdjoint",
      theoremName := "transport_rank_one;secular_eq_cubic;secular_root_gives_eigenvector;transport_self_adjoint", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-HODGE-THREE-LEVEL-SPECTRUM-001", moduleName := "D0.Synthesis.HodgeThreeLevelSpectrum",
      theoremName := "top_hodge_factorizes;mckean_singer;susy_assembly;betti_readout;doubling_law;moment_M2", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-GENERIC-SCENE-CALCULUS-001", moduleName := "D0.Synthesis.GenericSceneCalculus",
      theoremName := "moment0;moment1;moment2;euler_generic;rival_rules_dependent", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ZONE-IS-GENERATION-001", moduleName := "D0.Synthesis.ZoneIsGeneration",
      theoremName := "decomposition;decomposition_unique;dark_mem_ker", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ZONE-COUNT-MULTIPLICATIVE-001", moduleName := "D0.Synthesis.ZoneCountFromSpectrum;D0.Synthesis.ZoneCountCompleteness",
      theoremName := "only_eleven_carries_five;only_thirteen_carries_three;remainder_forced;unique_betti;length_bound", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-TRANSPORT-SPECTRUM-BLINDNESS-NOGO-001", moduleName := "D0.Synthesis.TransportSpectrumBlindness",
      theoremName := "isospectral_witness;isospectral_witness_two;transport_not_injective;scene_pinned_by_ET;blindness_and_pinning", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-TRANSPORT-NOT-GOLDEN-001", moduleName := "D0.Spectral.TransportNotGolden",
      theoremName := "transport_roots_bracketed;no_golden_transport_mode", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-DARK-EOS-DISCRETE-SET-001", moduleName := "D0.Synthesis.RoleOrientationEOS;D0.Synthesis.DarkEOSDiscreteSet;D0.Synthesis.LambdaCDMExcluded;D0.Synthesis.RoleModelDiscrimination;D0.Synthesis.RoleAssignmentNarrowing;D0.Synthesis.DarkEOSMagnitudeFree",
      theoremName := "lambda_cdm_excluded;dark_eos_discrete;minimal_deviation;narrowing", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-PARTITION-ALGEBRA-001", moduleName := "D0.Foundation.PartitionAlgebra",
      theoremName := "mem_iff_constant_on_classes", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ZONE-CONNECTIVITY-001", moduleName := "D0.Foundation.ZoneConnectivity",
      theoremName := "reach_iff_sameZone", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-SUBCRITICAL-TRACE-CLASS-001", moduleName := "D0.Spectral.SubcriticalTraceClass",
      theoremName := "summable_iff_subcritical;not_summable_at_wall;core_carrier_object", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-CASCADE-FLOOR-ORIENTATION-PARITY-001", moduleName := "D0.Foundation.CascadeFloorOrientationParity",
      theoremName := "orientationClosed_iff_even;cascade_floor_orientation_parity", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-SYMMETRIC-FUNCTION-ACTIVE-SPECTRUM-001", moduleName := "D0.Synthesis.SymmetricFunctionCalculus;D0.Synthesis.ActiveSplittingFromDistinctness;D0.Synthesis.ActiveSpectrumClosedForm;D0.Synthesis.ActiveWindowIrrational",
      theoremName := "active_product;scene_active_product;gap_sos;gap_zero_iff_equal;scene_discriminant;disjoint_from_integers;sep_leg_structural", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-SCENE-HEAT-KERNEL-001", moduleName := "D0.Synthesis.SceneHeatKernel",
      theoremName := "projector_partition;zoneHeat_from_diag;total_heat_is_P0;zetaL_values", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-SCENE-TRACE-HEAT-CAPACITY-001", moduleName := "D0.Synthesis.SceneTraceHeatCapacity",
      theoremName := "cut_zone;zone_region_never_saturates;full_scene_saturated;covertex_saturated;lucas_defect_of_full_scene;scene_trace_heat_capacity", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-SCENE-SPECTRAL-ACTION-001", moduleName := "D0.Synthesis.SceneSpectralAction",
      theoremName := "a0_at_scene;a2_at_scene;eh_proxy_is_edge_count", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-TRANSPORT-FORK-ENDGAME-001", moduleName := "D0.Synthesis.TransportForkEndgame",
      theoremName := "transport_fork_endgame;door_five_unstable;twelve_profiles_differ;stable_contraction_is_phi_inv;twelve_from_the_same_return;seventeen_ticks", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-EQUIVARIANT-HYPERCHARGE-CARRIER-001", moduleName := "D0.Synthesis.EquivariantHyperchargeCarrier",
      theoremName := "vertex_carrier_nogo;unoriented_edge_carrier_nogo;oriented_edge_image_card_le_six;hypercharge_row_six;hypercharge_row_five", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-EQUIVARIANT-MATRIX-STRUCTURE-001", moduleName := "D0.Synthesis.EquivariantMatrixStructure",
      theoremName := "equivariant_normal_form;archive_scalar_action;archive_actions_commute;no_equivariant_archive_noncommutativity", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-LEFSCHETZ-ZONE-EXCLUSION-001", moduleName := "D0.Synthesis.LefschetzZoneExclusion",
      theoremName := "nfermion_closed_form;thirteen_no_direct_address;thirteen_no_periodic_address;composite_address_value_unique;periodic_five;lucas_recurrence_shares_degree_arithmetic", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-YUKAWA-COMMUTANT-SPECTRUM-001", moduleName := "D0.Synthesis.YukawaCommutantSpectrum",
      theoremName := "no_rational_root_rat;qq_spectrum_splits;no_rational_value_at_root;equivariant_yukawa_rigidity", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-YUKAWA-QUALITATIVE-SELECTOR-NOGO-001", moduleName := "D0.Synthesis.YukawaQualitativeSelectorNoGo",
      theoremName := "nonScalar_values_injective;nonScalar_values_irrational;all_nonScalar_profile_equivalent;affineFamily_nonScalar;affineFamily_injective;affineFamily_profile_collapse;profile_selector_constant_on_nonScalar;no_unique_nonScalar_profile_selector;unique_selector_requires_new_information;transportRootFrame_exists;transport_yukawa_selector_nogo", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-YUKAWA-SPECTRAL-FIBER-LADDER-001", moduleName := "D0.Synthesis.YukawaSpectralFiber",
      theoremName := "orderedEig_injective;spectral_choose_injective;spectral_fiber_finite;spectral_fiber_card_le_six;qualitative_fiber_infinite;yukawa_selection_ladder", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-TRANSPORT-ROOT-LABELING-CANONICAL-001", moduleName := "D0.Synthesis.TransportRootLabeling",
      theoremName := "transport_root_labeling_canonical", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-MASS-SECTOR-ORIENTATION-BIT-001", moduleName := "D0.Synthesis.MassSectorSelection",
      theoremName := "mass_sector_orientation_bit", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-GENERATION-ROOT-ORDER-BRIDGE-001", moduleName := "D0.Synthesis.GenerationRootOrderBridge",
      theoremName := "generationRootBridge_inner;generationRootBridge_core;generationRootBridge_outer;generation_root_order_bridge_unique", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-CHARGED-LEPTON-SHELL-BRIDGE-001", moduleName := "D0.Synthesis.ChargedLeptonShellBridge",
      theoremName := "chargedLeptonExponent_strict;bridge_electron;bridge_muon;bridge_tau;chargedLeptonShellBridge_strict;chargedLeptonShellBridge_unique;charged_lepton_structural_naming_closed", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-MASS-SECTOR-METRIC-UNDERDETERMINATION-001", moduleName := "D0.Synthesis.MassSectorMetricUnderdetermination",
      theoremName := "shellGap_eq_minor;shellGap_pos;core_radius_eq_one_add_gap;outer_radius_eq_one_add_two_gap;outer_core_gap_eq_shellGap;torusParameter_eq_one_add_two_gap;positiveGapToTorus_torusToPositiveGap;torusToPositiveGap_positiveGapToTorus;torusParameterEquivPositiveGap;shellGap_injective;chargedLeptonTransportBridge_electron;chargedLeptonTransportBridge_muon;chargedLeptonTransportBridge_tau;radialOrderCode_constant;orderOnlySelector_constant;metricWitnessTwo_gap;metricWitnessThree_gap;metricWitnessTwo_ne_Three;no_unique_order_only_metric_selector;mass_sector_metric_boundary", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-MASS-SECTOR-COMPLETION-NOGO-001", moduleName := "D0.Synthesis.MassSectorCompletionNoGo",
      theoremName := "all_nonScalar_mass_candidates_equivalent;factorsThroughCurrentMassData_coefficientBlind;factorsThroughCurrentMassData_radialBlind;no_unique_mass_selector_if_coefficientBlind;no_unique_mass_selector_if_radialBlind;no_unique_current_mass_data_selector;unique_mass_selector_requires_two_axis_information;mass_sector_completion_information_boundary", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-AFFINE-SHELL-READOUT-NOGO-001", moduleName := "D0.Synthesis.AffineShellReadoutNoGo",
      theoremName := "affineReadout_inner;affineReadout_core;affineReadout_outer;affineReadout_equally_spaced;affineReadout_second_difference_zero;affineReadout_gap;affineReadout_normalized_ratio;affineReadout_target_equally_spaced;unequal_spacing_not_affine_reachable;puiseux_row_not_equally_spaced;puiseux_row_not_affine_reachable;affine_shell_readout_boundary", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-CANONICAL-PUISEUX-SHELL-TRANSFER-001", moduleName := "D0.Synthesis.CanonicalPuiseuxShellTransfer",
      theoremName := "normalizedShellCoordinate_inner;normalizedShellCoordinate_core;normalizedShellCoordinate_outer;normalizedQuadraticReadout_inner;normalizedQuadraticReadout_core;normalizedQuadraticReadout_outer;canonicalPuiseuxShellReadout_inner;canonicalPuiseuxShellReadout_core;canonicalPuiseuxShellReadout_outer;puiseux_row_discrete_curvature;puiseux_quadratic_coefficients_unique;normalizedQuadraticReadout_coefficients_unique;puiseux_quadratic_curvature_negative;puiseux_row_normalized_quadratic_reachable;puiseux_row_quadratic_reachable;puiseux_shell_transfer_minimal_degree_two;canonical_puiseux_shell_transfer", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-PUISEUX-TRANSFER-SATURATION-001", moduleName := "D0.Synthesis.PuiseuxTransferSaturation",
      theoremName := "puiseuxQuadraticShape_factor;puiseuxQuadraticShape_vertex_identity;puiseuxQuadraticShape_le_vertex;puiseuxQuadraticShape_eq_vertex_iff;puiseux_first_increment;puiseux_second_increment;puiseux_increment_compression_three;canonicalPuiseuxShellReadout_outer_unique_max;canonical_shell_increment_compression_three;puiseux_transfer_saturation", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-SEAM-CROSSING-WEIGHT-001", moduleName := "D0.Synthesis.SeamCrossingWeightForced",
      theoremName := "equivariant_weights_equal;twelfth_root_unique;crossing_weight_forced;nonuniform_freedom;seam_crossing_composed;seam_crossing_reduction", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-EDGE359-SCENE-SELECTION-NOGO-001", moduleName := "D0.Synthesis.Edge359SceneSelectionBoundary",
      theoremName := "source_scene_counts;edge359_rival_counts;edge359_rival_ne_source;edge359_not_scene_injective;edgeOnlySelector_accepts_rival;scene_unique_from_vertex_and_edge;source_scene_realizes_vertex_and_edge;edge359_scene_selection_boundary", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-SCENE-INVARIANT-OVERDETERMINATION-001", moduleName := "D0.Synthesis.SceneInvariantOverdetermination",
      theoremName := "source_invariants;vertex_not_selective;edge_not_selective;triangle_not_selective;vertex_edge_selective;vertex_triangle_selective;edge_triangle_selective;scene_invariant_overdetermination", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-SECTOR-FIELD-INDEPENDENCE-001", moduleName := "D0.Synthesis.SectorFieldIndependence",
      theoremName := "sde_window_disc;radicand_alpha_not_square;radicand_de_not_square;radicand_tr_not_square;alpha_de_distinct;alpha_tr_distinct;de_tr_distinct;triple_independent;ten_disc_not_square;sector_field_independence;no_quadraticAlgEquiv_of_not_squares;alpha_de_no_algEquiv;alpha_tr_no_algEquiv;de_tr_no_algEquiv;sector_quadratic_algebras_pairwise_nonisomorphic;alpha_character_finrank;alpha_de_character_finrank;sector_character_finrank;sector_signs_involutive;sector_signs_commute;sector_sign_character_table;sector_character_assembly;not_isSquare_algebraMap;ten_not_square_in_alpha;kernel_not_square_in_alpha;kernel_times_ten_not_square_in_alpha;kernel_not_square_in_alphaDE;sector_compositum_no_zero_divisors;sector_compositum_degree_eight_field;sigmaAlpha_alphaAxis;sigmaAlpha_deAxis;sigmaAlpha_transportAxis;sigmaDE_alphaAxis;sigmaDE_deAxis;sigmaDE_transportAxis;sigmaTransport_alphaAxis;sigmaTransport_deAxis;sigmaTransport_transportAxis;sector_sign_eigen_table", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-SECTOR-GALOIS-CLOSURE-001", moduleName := "D0.Synthesis.SectorGaloisClosure",
      theoremName := "signAut_alphaAxis;signAut_deAxis;signAut_transportAxis;signAut_injective;sector_galois_card;sector_isGalois;signAut_bijective;sector_galois_closure", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-FIVE-SECTOR-FIELD-LEDGER-001", moduleName := "D0.Synthesis.FiveSectorFieldLedger",
      theoremName := "geometry_character;gravity_character;electromagnetism_character;mass_character;darkEnergy_character;characterReadout_eq_zero_iff;characterReadout_surjective;characterReadout_range_eq_top;five_sector_character_rank;physicsSector_card;five_sector_character_kernel_rank;sectorCharacter_eq_iff;transport_has_no_alpha_or_de_coordinate;transport_has_no_alpha_coordinate;transport_has_no_de_coordinate;five_sector_field_ledger", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-TRANSPORT-CUBIC-GALOIS-CONFINEMENT-001", moduleName := "D0.Synthesis.TransportCubicGalois",
      theoremName := "Pcubic_separable;Pcubic_gal_card_eq_finrank;three_dvd_card;card_gal_le_six;card_gal_pos;card_gal_three_or_six;finrank_splitting_three_or_six;transport_cubic_galois_confinement;Pcubic_degree_three;transport_discr_eq;transport_discr_not_square", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-TRANSPORT-CUBIC-GALOIS-S3-001", moduleName := "D0.Synthesis.TransportCubicGaloisS3",
      theoremName := "rootSet_card;root_injective;root_cubic;pair_relation;roots_sum_zero;roots_pair_sum;roots_product;det_vandermonde_root;vandermondeDelta_sq;rootPerm_sign_eq_one_of_card_three;map_vandermondeDelta;vandermondeDelta_fixed_of_card_three;discr_isSquare_of_card_three;gal_card_ne_three;transport_gal_card_eq_six;transport_splitting_finrank_eq_six;rootPermHom_injective;rootPermHom_bijective;transportGalEquivS3;transport_cubic_galois_S3;perm3_hom_eq_one_or_sign;sqrt_not_mem_of_not_square;sqrt5_not_mem;sqrt10_not_mem;transport_splitting_excludes_sqrt5_sqrt10", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-SEAM-RETURN-ADDRESS-RIGIDITY-001", moduleName := "D0.Synthesis.SeamReturnAddressRigidity",
      theoremName := "owned_angle_is_address_ratio;twelve_five_is_address;return_address_unique;address_coprime;address_forces_seam_return;address_forces_transport_return;address_forces_total_factorization;seam_return_address_rigidity", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-M1-CASCADE-SCENE-PARAMETRIC-NOGO-001", moduleName := "D0.Foundation.M1CascadeSceneNoGo",
      theoremName := "present_model_at_every_positive_count;two_and_four_zone_countermodels;present_grammar_does_not_determine_zoneCount;zoneAssignmentK_iff_bound;gluedKindToTwo_not_injective;four_zone_rank_eq_four;zoneCount_eq_repairCard;datumKindRepresentation_nonvacuous;deleting_lower_leg_allows_two;deleting_upper_leg_allows_four;no_uniform_datumKind_representation_from_present_facts", status := ClaimStatus.leanNoGoProved },
    ...
    { claimId := "D0-INDEPENDENT-DETECTION-SIDE-SYMMETRY-BOUNDARY-001", moduleName := "D0.Foundation.IndependentDetectionSideSymmetryBoundary",
      theoremName := "rightArity_support;rightArity_value;left_right_repairs_distinct;left_right_supports_distinct;arity_quotient_not_support_injective;swap_left_history_is_right;M1_does_not_force_side_exchange;fourSupport_injective;four_exact_supports_realised;independent_detection_side_symmetry_boundary", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-CONCRETE-REPAIR-FORCING-CANONICITY-001", moduleName := "D0.Foundation.ConcreteRepairForcingCanonicity",
      theoremName := "sameSupportOrbit_iff_samePhysicalRepairObservation;left_right_same_protocol_orbit;protocolSupportOrbitSetoid_eq_physical;protocolRepairQuotientEquivStructural;canonical_repair_shell_map_rank_preserving;rank_preserving_repair_shell_map_unique;capacity_center_and_spread;capacity_shell_sizes;capacity_shell_size_matches_named_table;carried_repair_capacity_sizes;closedDefectClass_nontrivial;closed_defect_generates_circulation;closed_defect_forces_minimal_shell;concrete_repair_forcing_canonicity", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-SELF-UNFOLDING-OBSERVABLE-RELATIONS-001", moduleName := "D0.Cosmology.SelfUnfoldingObservableRelations",
      theoremName := "depthGap_composes;onePlusInternalRedshift_cocycle;repeated_detection_one_step;internal_redshift_drift_relation;one_step_generator_unique;origin_redshift_eq_archive_growth;scale_increment_eq_archive_growth_increment;origin_redshift_drift_eq_archive_growth_increment;drift_scale_archive_same_increment;tick_expansion_reciprocity;physical_redshift_identification_not_internal;self_unfolding_observable_relations", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-DYNAMIC-ARCHIVE-MEASURE-REDSHIFT-RELATION-001", moduleName := "D0.Cosmology.SelfUnfoldingObservableRelations",
      theoremName := "dynamic_shares_partition_unity;dynamic_archive_share_eq_redshift_fraction;first_dynamic_archive_share_eq_golden_trace;dynamic_measure_ne_static_dimension_share;self_unfolding_observable_relations", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-PHYSICAL-REDSHIFT-DETECTION-PASSPORT-001", moduleName := "D0.Bridge.PhysicalRedshiftDetection",
      theoremName := "represented_physicalOnePlusRedshift_eq_internal;represented_physical_redshift_drift_relation", status := ClaimStatus.leanBridgeAssumptionsExplicit },
    { claimId := "D0-RAW-DOUBLE-DETECTION-REDSHIFT-NOGO-001", moduleName := "D0.Cosmology.PhysicalRedshiftDetectionPassport",
      theoremName := "rawProtocolForRatio;raw_double_detection_realises_every_positive_ratio;raw_double_detection_does_not_force_redshift;rival_redshift_requires_relativeCalibration_defect", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-FINITE-PHASE-CYCLE-FREQUENCY-REALIZATION-001", moduleName := "D0.Cosmology.PhaseCycleFrequencyRealization",
      theoremName := "phaseQuarterTurn_four;phaseQuarterTurn_three_not_full;completed_phase_cycles_are_returns;cycleFrequencyReadout_one_step;phaseCycleFrequencyProtocol;phase_cycle_frequency_ratio_eq_internal;phase_cycle_frequency_drift_relation;finite_phase_cycle_frequency_realization", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-RAW-CYCLE-WINDOW-REDSHIFT-NOGO-001", moduleName := "D0.Cosmology.PhaseCycleFrequencyRealization",
      theoremName := "internalScale_transport;internalScale_ratio_eq_internal;raw_cycle_window_defect_factorization;same_count_and_normalizedWindow_forces_internal;rival_requires_count_or_normalizedWindow_defect;raw_cycle_window_realises_every_positive_ratio;raw_cycle_window_does_not_force_redshift", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-REDSHIFT-SI-TICK-CALIBRATION-NOGO-001", moduleName := "D0.Bridge.RedshiftSITickCalibrationNoGo",
      theoremName := "rho_rescale;rho_calibrationForRate;same_internal_protocol_distinct_si_rates;no_si_rho_identifiable_from_internal_protocol;redshift_si_tick_calibration_nogo", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-REDSHIFT-DRIFT-EXPANSION-COUPLING-001", moduleName := "D0.Bridge.RedshiftExpansionArchiveCoupling",
      theoremName := "expansion_shape_after_eliminating_drift;normalized_expansion_constant;unequal_normalized_expansion_forces_rate_variation", status := ClaimStatus.leanBridgeAssumptionsExplicit },
    { claimId := "D0-EXPANSION-DARK-RESPONSE-COUPLING-001", moduleName := "D0.Bridge.RedshiftExpansionArchiveCoupling",
      theoremName := "radial_bao_archive_candidate_coupling;represented_dark_response_coupling;redshift_expansion_archive_coupling", status := ClaimStatus.leanBridgeAssumptionsExplicit },
    { claimId := "D0-LOCAL-PRESSURE-CAPACITY-DYNAMICS-001", moduleName := "D0.Gravity.LocalPressureCapacityDynamics",
      theoremName := "balanced_acceleration_zero;balanced_preserves_existing_rate;feedback_excess_accelerates;capacity_excess_brakes;capacity_hypercompensation_reverses;unequal_imbalance_forces_unequal_acceleration;homogeneous_imbalance_gives_homogeneous_acceleration;local_pressure_capacity_dynamics_and_packing_boundary", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-PACKING-LIMIT-HOMOGENEITY-NOGO-001", moduleName := "D0.Gravity.LocalPressureCapacityDynamics",
      theoremName := "packing_limit_does_not_force_homogeneity;everywhere_saturation_forces_homogeneity;local_pressure_capacity_dynamics_and_packing_boundary", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-LOCAL-RAYCHAUDHURI-REPRESENTATION-001", moduleName := "D0.Bridge.LocalRaychaudhuriRepresentation",
      theoremName := "added_matter_increases_focusing;added_dark_drive_increases_defocusing;represented_local_acceleration_eq_defocusing_sub_focusing;represented_balance_zero_acceleration;represented_defocusing_dominance_accelerates;represented_focusing_dominance_brakes;represented_focusing_hypercompensation_reverses;represented_dark_drive_recovered;represented_focusing_recovered;local_raychaudhuri_representation_coupling", status := ClaimStatus.leanBridgeAssumptionsExplicit },
    { claimId := "D0-NET-RESPONSE-DARK-DECOMPOSITION-NOGO-001", moduleName := "D0.Bridge.LocalRaychaudhuriRepresentation",
      theoremName := "common_shift_preserves_net;nonzero_common_shift_gives_observational_twin;no_dark_component_identifiable_from_net;dark_component_recovered_from_net_and_focusing;same_net_and_focusing_forces_same_dark;same_net_distinct_focusing_forces_distinct_dark;local_raychaudhuri_representation_coupling", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-VERIFIABILITY-CLASS-001", moduleName := "D0.Foundation.VerifiabilityNecessity",
      theoremName := "operationally_verifiable_or_unverifiable_story;operationally_verifiable_not_story;protocolTheoryVerification;canonicalProtocol_verifiable", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-VERIFIABILITY-FORCES-FUNCTIONAL-TUPLE-001", moduleName := "D0.Foundation.VerifiabilityNecessity",
      theoremName := "record_injective;verification_lines_agree;protocol_verifiability_forces_functional_tuple;verifiability_forces_functional_tuple;verificationRecordRelation_iff_eq;verificationRecordConnectivity_iff_eq", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-OPERATIONAL-MDL-ROLE-MINIMALITY-001", moduleName := "D0.Foundation.VerifiabilityNecessity",
      theoremName := "semanticImage_eq_univ_of_complete;semanticCost_eq_three_of_complete;canonicalRoles_nameMinimal;same_functions_different_language_equivalent;redundantRoles_complete;redundantRole_removed_still_complete;redundantRoles_not_nameMinimal;operational_mdl_role_minimality", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-M1-AS-VERIFIABILITY-NECESSITY-001", moduleName := "D0.Foundation.VerifiabilityNecessity",
      theoremName := "m1_as_verifiability_necessity;verifiableLineEmbedding;all_lines_M1_iff_not_catalogue_outsourced;privileged_catalogue_can_distinguish;privileged_catalogue_is_outcome_affecting;privileged_catalogue_not_M1;necessary_role_outsourced_loses_verifiability", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-PERRON-PHI3-STRUCTURAL-CRITICALITY-001", moduleName := "D0.Spectral.PerronPhi3Carrier",
      theoremName := "partialSum_unbounded;normLog_tendsto;logCesaroPhi3_tendsto;dixmier_coefficient_ne_zero;perron_phi3_structural_criticality", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-PERRON-PHI3-CARRIER-OWNER-001", moduleName := "D0.Spectral.PerronPhi3Carrier",
      theoremName := "perron_phi3_calibration_is_normalized", status := ClaimStatus.deprecated },
    { claimId := "D0-CAYLEY-DICKSON-TOWER-001", moduleName := "D0.Algebra.CayleyDickson",
    ...
    { claimId := "D0-SEDENION-D0-REPRESENTATION-FUNCTOR-001", moduleName := "D0.Algebra.SedenionClifford8",
      theoremName := "clifford8_relations;clifford_monomial_tr_id;clifford_monomial_tr_zero;witt_car_aa;witt_car_adag_adag;witt_car_a_adag;sedenion_clifford8_car_generation_core", status := ClaimStatus.openObligation },
    { claimId := "D0-CLIFFORD-THREE-INDEPENDENT-FAMILIES-001", moduleName := "D0.Algebra.CliffordThreeFamilies",
      theoremName := "semi_spinor_total_dim_eq;full_gen_total_dim_eq;vac_proj0_nonzero;clifford_three_independent_families_owner", status := ClaimStatus.openObligation },
    { claimId := "D0-CLIFFORD-SINGLE-GAUGE-SECTOR-001", moduleName := "D0.Algebra.CliffordThreeFamilies",
      theoremName := "clifford_single_gauge_sector_owner", status := ClaimStatus.openObligation },
    ...
    { claimId := "D0-LOCAL-TICK-GAUGE-DISCRIMINATION-001", moduleName := "D0.Bridge.LocalTickGaugeDiscrimination",
      theoremName := "global_tick_rescaling_is_gauge;local_inhomogeneous_tick_is_physical_field;local_tick_gauge_discrimination_owner", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-GOLDEN-PSEUDOMETRIC-CAUCHY-OWNER-001", moduleName := "D0.Bridge.GromovHausdorff",
      theoremName := "golden_pseudometric_cauchy;generic_metric_cauchy_owner;real_sequence_scope_witness;pseudometric_cauchy_scope", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-GROMOV-HAUSDORFF-DEQUARANTINE-001", moduleName := "D0.Bridge.GromovHausdorff",
      theoremName := "pseudometric_cauchy_scope", status := ClaimStatus.deprecated },
    { claimId := "D0-LATREMOLIERE-QUANTUM-PROPINQUITY-TARGET-001", moduleName := "D0.Bridge.GromovHausdorff",
      theoremName := "LatremoliereQuantumPropinquityTarget", status := ClaimStatus.leanBridgeAssumptionsExplicit },
    ...
    { claimId := "D0-FIEDLER-TILT-TAUTOLOGY-NOGO-001", moduleName := "D0.Cosmology.FiedlerTiltTautologyNoGo",
      theoremName := "matched_scale_tilt_universal;fiedler_minus_one_is_matched_scale_instance;fiedler_fixed_mode_scale_dependence;fiedler_tilt_not_scale_invariant;fiedler_tilt_tautology_nogo", status := ClaimStatus.leanNoGoProved },
    ...
    { claimId := "D0-CMB-EQUIVARIANT-PHASON-CURVATURE-TRANSFER-NOGO-001", moduleName := "D0.Cosmology.EquivariantPhasonCurvatureTransferNoGo",
      theoremName := "Q_annihilates_zone_balanced;Q_mul_matrix_eq_zero_of_columns_balanced;equivariant_transfer_annihilated_by_Q;equivariant_phason_curvature_transfer_nogo;adj31_equivariant;lap_equivariant;equivariant_phason_curvature_transfer_owner", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-CMB-PHASON-TRANSFER-MAXIMALITY-NOGO-001", moduleName := "D0.Cosmology.PhasonTransferMaximalityNoGo",
      theoremName := "carrier_dimension_mismatch;higgs_scalar_projector_trace;fiedler_projector_trace;phason_transfer_maximality_nogo_owner", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-ARCHIVE-WEYL-DIMENSION-VACUITY-NOGO-001", moduleName := "D0.Geometry.ArchiveWeylDimensionVacuityNoGo",
      theoremName := "hasWeylDimension_vacuous;archiveHeatTrace4D_vacuous;hasWeylDimension_vacuous_false;archive_weyl_dimension_vacuity_nogo_owner", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-ARCHIVE-ENUMERATION-SPECTRUM-WEYL4-NOGO-001", moduleName := "D0.Geometry.ArchiveEnumerationSpectrumWeyl4NoGo",
      theoremName := "card_fin_val_le;archiveEigenvalue_le_iff;eigenCountBelow_eq_succ;enumeration_scaling_is_linear;archive_enumeration_spectrum_weyl4_nogo_owner", status := ClaimStatus.leanNoGoProved },
    ...
    { claimId := "D0-ARCHIVE-METRIC-LAPLACIAN-SCALE-OWNER-001", moduleName := "D0.Geometry.ArchiveMetricLaplacianScaleNoGo",
      theoremName := "metric_scale_strictly_exceeds_combinatorial;metric_scale_strictly_increasing;lattice_spacing_strictly_decreasing;metricProductLaplacian_symmetric;archive_metric_laplacian_scale_owner", status := ClaimStatus.leanNoGoProved },
    ...
    { claimId := "D0-ARCHIVE-OPERATOR-IDENTITY-AUDIT-001", moduleName := "D0.Geometry.ArchiveOperatorIdentityAudit",
      theoremName := "phase_dim_ne_product_dim;record_ne_enumerative_at_zero;enumerative_trace_growth_at_level_zero;archive_operator_identity_audit_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-FLAT-PRODUCT-BONDING-NOGO-001", moduleName := "D0.Geometry.ArchiveFlatProductBondingNoGo",
      theoremName := "card_flat_zero_fiber;card_cycle_zero_fiber_1D;product_zero_fiber_card_eq_sixteen;flat_ne_product_fiber_card;archive_flat_product_bonding_nogo_owner", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-ARCHIVE-TWO-LIMIT-SEPARATION-001", moduleName := "D0.Geometry.ArchiveTwoLimitSeparation",
      theoremName := "record_limit_inhabited;record_level_zero_points;product_level_zero_points;archive_two_limit_separation_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-PHASE-EDGE-METRIC-SCALE-001", moduleName := "D0.Geometry.ArchivePhaseEdgeMetricScale",
      theoremName := "archiveAdjacent_phaseDistance;metric_scale_eq_inverse_square_edge_length;archive_phase_edge_metric_scale_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-4D-METRIC-LAPLACIAN-001", moduleName := "D0.Geometry.ArchiveRoleProductLaplacian",
      theoremName := "archiveMetricProductLaplacian_symmetric;archiveMetricProductLaplacian_constant_zero;archiveProductLaplacian_diag;small_cycle_diagonal_at_zero;small_cycle_diagonal_at_one;archive_4d_metric_laplacian_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-HODGE-DIRAC-EUCLIDEAN-METRIC-MISMATCH-NOGO-001", moduleName := "D0.Geometry.ArchiveHodgeDiracMetricMismatchNoGo",
      theoremName := "d1_eval;d2_sq_eval;d1_sq_ne_d2_sq;d1_sq_eq_two_mul_d2_sq;archive_hodge_dirac_euclidean_metric_mismatch_nogo_owner", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-ARCHIVE-SEAM-CURVATURE-SCOPE-001", moduleName := "D0.Geometry.ArchiveSeamCurvatureScope",
      theoremName := "seamHSNormSq4D_at_two;seam_1D_ne_4D_at_two;seam_4D_grows;archive_seam_curvature_scope_owner", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-ARCHIVE-1D-TO-4D-RG-LIFT-NOGO-001", moduleName := "D0.Geometry.Archive1Dto4DRGLiftNoGo",
      theoremName := "trace_M_base;trace_I2;M_base_ne_I2;trace_product_Gram_4D_eval;trace_product_I_4D_eval;product_Gram_ne_I4D;archive_1d_to_4d_rg_lift_nogo_owner", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-ARCHIVE-ROLE-SIGNATURE-SEPARATION-001", moduleName := "D0.Geometry.ArchiveRoleEquivalence",
      theoremName := "roleRoleSigEquiv;role_signature_datum_independent", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-PRODUCT-SPECTRUM-CONVERGENCE-001", moduleName := "D0.Geometry.ArchiveProductSpectrumConvergence",
      theoremName := "discrete_product_zero_mode;continuum_flat_zero_mode;heatTraceFactorizationPower_eq_card_role;archive_product_spectrum_convergence_owner", status := ClaimStatus.openObligation },
    { claimId := "D0-ARCHIVE-NATURAL-TWISTED-DIRAC-OWNER-001", moduleName := "D0.Geometry.ArchiveNaturalTwistedDirac",
      theoremName := "mod_succ_ne_self;forward_adjoint_eq_neg_backward;archive_natural_twisted_dirac_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-CONCRETE-SPECTRAL-PROPINQUITY-001", moduleName := "D0.Geometry.ArchiveConcreteSpectralPropinquity",
      theoremName := "spinorModuleDimension_eq_pow_role;common_limit_cauchy_bound;archive_concrete_spectral_propinquity_owner", status := ClaimStatus.openObligation },
    { claimId := "D0-ARCHIVE-4D-CURVATURE-PERTURBATION-BRIDGE-001", moduleName := "D0.Geometry.Archive4DCurvaturePerturbationBridge",
      theoremName := "zero_perturbation_is_flat;archive_4d_curvature_perturbation_bridge_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-SEAM-CANONICITY-001", moduleName := "D0.Geometry.ArchiveSeamCanonicity",
      theoremName := "seam_hs_norm_constant;archive_seam_canonicity_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-EXTERNAL-RESEARCH-STATUS-INFLATION-AUDIT-001", moduleName := "D0.Verification.ExternalResearchStatusInflationAudit",
      theoremName := "external_research_status_inflation_audit_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-SEDENION-BRANCH-THREESET-SCAFFOLD-001", moduleName := "D0.Algebra.Sedenions",
      theoremName := "sedenion_branch_threeset_scaffold_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-TRIALITY-SEDENION-S3-DISJOINTNESS-GUARD-001", moduleName := "D0.Algebra.Sedenions",
      theoremName := "triality_sedenion_s3_disjointness_guard", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-MAJORANA-BL-SCALAR-COMPENSATION-NOGO-001", moduleName := "D0.Algebra.AlbertJordan",
      theoremName := "majorana_with_scalar_does_not_force_b_zero;compensator_exists;majorana_bl_scalar_compensation_nogo_owner", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-ALBERT-SM-GAUGE-DIMENSION-ALIGNMENT-001", moduleName := "D0.Gauge.AlbertSMProjection",
      theoremName := "albert_sm_gauge_dimension_alignment_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ZPHI-ARITHMETIC-OWNER-001", moduleName := "D0.Condensed.SolidPhi",
      theoremName := "zphi_arithmetic_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-TRUNCATED-01-HODGE-ZERO-MODE-POLLUTION-NOGO-001", moduleName := "D0.Geometry.ArchiveHodgeDiracZeroModePollutionNoGo",
      theoremName := "hodge_kernel_at_two;hodge_kernel_pollution_divergence;archive_truncated_01_hodge_zero_mode_pollution_nogo_owner", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-ARCHIVE-ROLE-PHASE-GROUP-001", moduleName := "D0.Geometry.ArchiveRolePhaseGroup",
      theoremName := "card_archive_role_phase_group;archive_role_phase_group_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-CAR-FOCK-CARRIER-001", moduleName := "D0.Geometry.ArchiveCARFockCarrier",
      theoremName := "card_archive_fock_state;archive_car_fock_carrier_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-CAR-CLASS-MINIMALITY-001", moduleName := "D0.Geometry.ArchiveCARFockCarrier",
      theoremName := "car_faithful_rep_dim_multiple", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-CAR-PERMUTATION-CANONICITY-001", moduleName := "D0.Geometry.ArchiveCARFockCarrier",
      theoremName := "fock_dim_readout_constant;archive_car_permutation_canonicity_owner", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-ARCHIVE-CAR-ZERO-MODE-OWNER-001", moduleName := "D0.Geometry.ArchiveCARDirac",
      theoremName := "car_zero_mode_independent_of_L;archive_car_zero_mode_owner", status := ClaimStatus.openObligation },
    { claimId := "D0-ARCHIVE-CAR-PARITY-SPECTRUM-001", moduleName := "D0.Geometry.ArchiveCARDirac",
      theoremName := "fock_parity_dimension_split;fockParityMatrix_symmetric;fockParityMatrix_sq;fock_parity_anticommutes_with_gamma;carDirac_parity_anticommutation;spectral_symmetry_pairing;archive_car_parity_spectrum_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-CAR-SPECTRUM-AMPLIFICATION-001", moduleName := "D0.Geometry.ArchiveCARDirac",
      theoremName := "car_amplification_times_spinor_eq_sixteen;archive_car_spectrum_amplification_owner", status := ClaimStatus.openObligation },
    { claimId := "D0-ARCHIVE-DIRAC-HEATTRACE-MULTIPLICITY-001", moduleName := "D0.Geometry.ArchiveCARDirac",
      theoremName := "diracHeatTraceMultiplicity_eq_fock_dim;archive_dirac_heattrace_multiplicity_owner", status := ClaimStatus.openObligation },
    { claimId := "D0-ARCHIVE-PSEUDOINVERSE-TWIST-ALGEBRA-001", moduleName := "D0.Geometry.PseudoinverseTwistAlgebra",
      theoremName := "pseudoinverse_twist_exact_identity;archive_pseudoinverse_twist_algebra_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-CANONICAL-ZERO-MODE-PROJECTOR-001", moduleName := "D0.Geometry.ArchiveCanonicalZeroModeProjector",
      theoremName := "canonical_zero_mode_projector_rank_eq_fock_dim;spatial_average_weight_pos;archive_canonical_zero_mode_projector_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-DIRAC-PSEUDOINVERSE-OWNER-001", moduleName := "D0.Geometry.ArchiveDiracPseudoinverse",
      theoremName := "pseudoinverse_null_dim_eq_zero_mode_rank;archive_dirac_pseudoinverse_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-PSEUDOINVERSE-TWIST-OWNER-001", moduleName := "D0.Geometry.ArchivePseudoinverseTwist",
      theoremName := "archive_pseudoinverse_twist_owner", status := ClaimStatus.openObligation },
    { claimId := "D0-ARCHIVE-TWIST-DISPLACEMENT-BOUND-001", moduleName := "D0.Geometry.ArchivePseudoinverseTwist",
      theoremName := "twist_displacement_bound_factor_pos;twist_displacement_bound_factor_decreases;archive_twist_displacement_bound_owner", status := ClaimStatus.openObligation },
    { claimId := "D0-ARCHIVE-LATREMOLIERE-TORUS-INSTANTIATION-001", moduleName := "D0.Geometry.ArchiveLatremoliereTorusInstantiation",
      theoremName := "archive_latremoliere_torus_instantiation_owner", status := ClaimStatus.leanBridgeAssumptionsExplicit },
    { claimId := "D0-ARCHIVE-SPECTRAL-TRACE-MULTIPLICITY-GUARD-001", moduleName := "D0.Geometry.ArchiveLatremoliereTorusInstantiation",
      theoremName := "trace_multiplicity_guard_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ALBERT-SM-SUBGROUP-REPRESENTATION-OWNER-001", moduleName := "D0.Gauge.AlbertSMProjection",
      theoremName := "", status := ClaimStatus.openObligation },
    { claimId := "D0-CYCLOTOMIC-MU2-REALIZATION-001", moduleName := "D0.Condensed.SolidPhi",
      theoremName := "", status := ClaimStatus.openObligation },
    { claimId := "D0-ARCHIVE-CUBICAL-COCHAIN-CARRIER-001", moduleName := "D0.Geometry.ArchiveCubicalCochainCarrier",
      theoremName := "card_cubical_cochain_carrier;cubical_betti_sum_eq_sixteen;archive_cubical_cochain_carrier_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-CUBICAL-COBOUNDARY-001", moduleName := "D0.Geometry.ArchiveCubicalCoboundary",
      theoremName := "d_squared_eq_zero;archive_cubical_coboundary_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-1D-COCHAIN-REFINEMENT-001", moduleName := "D0.Geometry.Archive1DCochainRefinement",
      theoremName := "b1_isometry;intertwining_d_b0_eq_b1_d;archive_1d_cochain_refinement_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-GRADED-REFINEMENT-CHAIN-MAP-001", moduleName := "D0.Geometry.ArchiveGradedRefinementChainMap",
      theoremName := "archive_graded_refinement_chain_map_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-REFINEMENT-HODGE-WEIGHTS-001", moduleName := "D0.Geometry.ArchiveRefinementHodgeWeights",
      theoremName := "hodge_mass_trace_sum;archive_refinement_hodge_weights_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-METRIC-MEASURE-HODGE-LIFT-001", moduleName := "D0.Geometry.ArchiveMetricMeasureHodgeLift",
      theoremName := "metric_measure_hodge_lift_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-NAIVE-WEIGHTED-CAR-DEGREE-LEAKAGE-NOGO-001", moduleName := "D0.Geometry.ArchiveNaiveWeightedDegreeLeakageNoGo",
      theoremName := "archive_naive_weighted_degree_leakage_nogo_owner", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-ARCHIVE-WEIGHTED-HODGE-DIRAC-001", moduleName := "D0.Geometry.ArchiveWeightedHodgeDirac",
      theoremName := "archive_weighted_hodge_dirac_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-REFINEMENT-EXTRINSIC-CURVATURE-001", moduleName := "D0.Geometry.ArchiveExtrinsicRGCurvature",
      theoremName := "rg_curvature_identity;rg_curvature_as_gram", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-1D-RG-EXTRINSIC-CURVATURE-001", moduleName := "D0.Geometry.ArchiveExtrinsicRGCurvature",
      theoremName := "frozen1DExtrinsicInvariants;product_trace_density_4d", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-TENSOR-RG-METRIC-MEASURE-001", moduleName := "D0.Geometry.ArchiveTensorSeamCrossRoleNoGo",
      theoremName := "metric_component_eq_1d_seam", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-MATTER-LOCALIZATION-NONUNIQUENESS-NOGO-001", moduleName := "D0.Matter.MatterLocalizationNonuniquenessNoGo",
      theoremName := "matter_localization_nonuniqueness_nogo_owner", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-MATTER-LOCALIZATION-OBSERVABLE-CANONICITY-001", moduleName := "D0.Matter.MatterLocalizationNonuniquenessNoGo",
      theoremName := "matter_neutrality_m1_forced;matter_localization_observable_canonicity_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-JY-TO-PLAQUETTE-TYPE-BOUNDARY-001", moduleName := "D0.Geometry.ArchiveJYToPlaquetteBoundary",
      theoremName := "archive_jy_to_plaquette_type_boundary_owner", status := ClaimStatus.leanNoGoProved },
    { claimId := "D0-ROLE-ALTERNATING-PAIRING-001", moduleName := "D0.Core.RoleAlternatingPairing",
      theoremName := "roleOmega_iff_distinct_nonzero", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-CANONICAL-CROSS-ROLE-Z2-FLUX-001", moduleName := "D0.Core.RoleAlternatingPairing",
      theoremName := "roleOmega_perm_invariant;roleOmega_ABCD", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-OMEGA8-Q8-TYPED-BRIDGE-001", moduleName := "D0.Representation.Omega8Q8TypedBridge",
      theoremName := "omega8_q8_typed_bridge_master", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-QUATERNION-MIXED-CURVATURE-001", moduleName := "D0.Geometry.QuaternionMixedCurvature",
      theoremName := "quaternion_anticommutator_dot;quaternion_commutator_cross", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-QUATERNION-CROSS-ROLE-COMMUTATOR-ALGEBRA-001", moduleName := "D0.Geometry.QuaternionMixedCurvature",
      theoremName := "cross_role_curvature_01;cross_role_curvature_01_nonzero;cross_role_frobenius_magnitude", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-SPATIAL-CROSS-ROLE-FLUX-CANONICITY-001", moduleName := "D0.Geometry.SpatialCrossRoleFluxCanonicity",
      theoremName := "spatial_cross_role_flux_m1_forced", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-M1-RIESZ-REPRESENTATION-GAP-001", moduleName := "D0.Foundation.M1RieszRepresentationGap",
      theoremName := "verification_contract_coexists_with_nonuniform_mismatch;cardinality_bridge_not_unique;witness_landing_not_forced;outcome_sourced_readouts_agree;uniform_positive_weight_iff_mismatch_zero;outcome_agreement_does_not_force_uniform_weight;centering_coexists_with_nonuniform_mismatch;radius_one_eq_backward_forces_half", status := ClaimStatus.leanNoGoProved },
    ...
    { claimId := "D0-COEFFICIENT-COVARIANT-DIFFERENTIAL-001", moduleName := "D0.Geometry.ArchiveCovariantCubicalDifferential",
      theoremName := "dConn_add;dConn_smul;dConn_raises_degree;dConn_radius_one;dConn_trivial_eq_dForward;dConn_gauge;cartanConn_comm_dConn;dConn_sq_eq_curvature;dConn_sq_apply_eq_curvature;dConn_sq_zero_of_flat", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-MOVING-GRADED-DIFFERENTIAL-001", moduleName := "D0.Geometry.ArchiveMovingDifferential",
      theoremName := "movingDifferential_comp;movingDifferential_curvature;movingDifferential_preserves_sq_zero;movingDifferential_infinitesimal", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-PRIMAL-DUAL-MOVING-ACTION-001", moduleName := "D0.Geometry.ArchivePrimalDualMovingAction",
      theoremName := "pairing_dualAction;dualAction_unique;dualAction_mul;dualAction_inv;dualAction_invTranspose;movingHodge_comp;movingHodge_eq_self_iff_fixed;fixedHodge_iff_bilinearStabilizer", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-AFFINE-CARTAN-PATH-CLOSURE-001", moduleName := "D0.Geometry.ArchiveAffineCartanConnection;D0.Geometry.ArchiveFiniteCartanLieClosureNoGo;D0.Geometry.ArchivePathWordAlgebra",
      theoremName := "affine_mul_assoc;affinePath_append;affinePath_shift_eq_covariant_sum;affineGauge_lin;affineGauge_shift;affinePath_gauge;affineTranslation_flat_eq_forwardGaugeCoframe;affineOpenCurvature_gauge;affineOpenTorsion_gauge;affineBasedHolonomy_gauge;open_based_curvature_relation;open_based_torsion_relation;edgeGenerator_bracket_of_pairwise_ne;nestedBracket_simplePath;edgeLieClosure_eq_annihilatesConstants;finrank_annihilatesConstants;archive_scalar_closure_finrank;no_uniform_radius_lie_closed;finite_scalar_derivation_eq_zero;localGate_inverse;shift_mul_commute;crossed_monomial_mul;matrixUnit_eq_delta_shift;crossed_finrank;pathEval_append;pathEval_reverse;pathEval_factors_pairGroupoid_iff_trivial_holonomy;cost_add;cost_mul;cost_bracket;cost_reverse", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-A4D-SECOND-ORDER-ENERGY-COVARIANCE-001", moduleName := "D0.Geometry.A4DSecondOrderCartanCongruence;D0.Geometry.A4DAffineMatterLiftObstruction;D0.Geometry.A4DActionGroupoidSecondJet;D0.Geometry.A4DMovingDifferentialSecondJet;D0.Geometry.A4DCellHessianTransverseModulus;D0.Geometry.A4DLocatedMatterCellEnergy;D0.Geometry.A4DScalarDeltaSecondJet",
      theoremName := "secondOrderCongruenceCoefficient_formula;weightedCongruence_eq;exponentialSecondJet_specialization;backgroundJet_eq_congruence;exponential_background_specialization;dualInverseTranspose_quad;constitutiveSecondDerivative;ownedFlatTranslation_acceleration_zero;actionGroupoid_secondJet;actionGroupoid_mixedCocycle;movingDifferential_secondDerivative;mixedParent_secondDerivative;coframeDifferential_codimension;coframeKernelEquiv;exactCoframe_plaquetteCurl_zero;transverseCurlWitness_outside_image;referenceCellWeight_same_firstJet;referenceCellWeight_secondOrder_separates;locatedStar_does_not_select_reference_weight;scalarCycle_firstJet_eq_negative_symmetrized;scalarDelta_G_sq;scalarDelta_Gt_sq;scalarCycleH0_distanceTwo;delta_Ksym_mixed;delta_L5_necessary_entries;genericKSym_from_congruence;scalarReferenceWeight_quadraticCoefficient", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-A4D-DELTA-CARTAN-EXPONENTIAL-NOGO-001", moduleName := "D0.Geometry.A4DScalarDeltaSecondJet;D0.Geometry.A4DAffineMatterLiftObstruction",
      theoremName := "deltaCartan_exponentialSecondOrder_noCellDiagonalCompletion;deltaCartan_zeroSecondJet_noCellDiagonalCompletion;zeroCoefficient_is_not_exponential_completion;scalarReference_constantForm;constantsPreservation_rejects_nonzero_c;constantsPreservation_rejects_displayed_coefficients;diagonalAnsatz_constants_force_c_zero;delta_commutator_entry;nondelta_G_sq_ne_zero;additiveTwoJet_tangents_commute;backgroundIndependent_deltaTangents_do_not_commute;no_backgroundIndependent_deltaTangent_representation", status := ClaimStatus.leanNoGoProved },
