...
def claimMap : List ClaimMapEntry :=
  [
    ...
    { claimId := "D0-CLIFFORD-THREE-INDEPENDENT-FAMILIES-001", moduleName := "D0.Algebra.CliffordThreeFamilies",
      theoremName := "semi_spinor_total_dim_eq;full_gen_total_dim_eq;vac_proj0_nonzero;clifford_three_independent_families_owner", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-ARCHIVE-PRODUCT-SPECTRUM-CONVERGENCE-001", moduleName := "D0.Geometry.ArchiveProductSpectrumConvergence",
      theoremName := "discrete_product_zero_mode;continuum_flat_zero_mode;heatTraceFactorizationPower_eq_card_role;archive_product_spectrum_convergence_owner", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-ARCHIVE-CONCRETE-SPECTRAL-PROPINQUITY-001", moduleName := "D0.Geometry.ArchiveConcreteSpectralPropinquity",
      theoremName := "spinorModuleDimension_eq_pow_role;common_limit_cauchy_bound;archive_concrete_spectral_propinquity_owner", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-ARCHIVE-CAR-DIRAC-OWNER-001", moduleName := "D0.Geometry.ArchiveCARDirac",
      theoremName := "dirac_derivative_scale_eq_fibers;archive_car_dirac_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-CAR-DIRAC-SQUARE-001", moduleName := "D0.Geometry.ArchiveCARDirac",
      theoremName := "carDiracSquareScalarSectorFactor_eq_fock_dim;archive_car_dirac_square_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-CAR-ZERO-MODE-OWNER-001", moduleName := "D0.Geometry.ArchiveCARDirac",
      theoremName := "car_zero_mode_independent_of_L;archive_car_zero_mode_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-CAR-PARITY-SPECTRUM-001", moduleName := "D0.Geometry.ArchiveCARDirac",
      theoremName := "fock_parity_dimension_split;archive_car_parity_spectrum_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-CAR-SPECTRUM-AMPLIFICATION-001", moduleName := "D0.Geometry.ArchiveCARDirac",
      theoremName := "car_amplification_times_spinor_eq_sixteen;archive_car_spectrum_amplification_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-DIRAC-HEATTRACE-MULTIPLICITY-001", moduleName := "D0.Geometry.ArchiveCARDirac",
      theoremName := "diracHeatTraceMultiplicity_eq_fock_dim;archive_dirac_heattrace_multiplicity_owner", status := ClaimStatus.leanCoreProved },
    ...
    { claimId := "D0-ARCHIVE-PSEUDOINVERSE-TWIST-OWNER-001", moduleName := "D0.Geometry.ArchivePseudoinverseTwist",
      theoremName := "archive_pseudoinverse_twist_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-TWIST-DISPLACEMENT-BOUND-001", moduleName := "D0.Geometry.ArchivePseudoinverseTwist",
      theoremName := "twist_displacement_bound_factor_pos;twist_displacement_bound_factor_decreases;archive_twist_displacement_bound_owner", status := ClaimStatus.leanCoreProved },
    { claimId := "D0-ARCHIVE-LATREMOLIERE-TORUS-INSTANTIATION-001", moduleName := "D0.Geometry.ArchiveLatremoliereTorusInstantiation",
      theoremName := "archive_latremoliere_torus_instantiation_owner", status := ClaimStatus.leanCoreProved },
