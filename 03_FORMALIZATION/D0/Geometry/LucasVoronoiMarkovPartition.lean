...
Python certificates: `04_CERTIFICATES/vp_lucas_voronoi_markov_partition.py`,
`04_CERTIFICATES/vp_toral_time_markov_conjugacy.py`, `04_CERTIFICATES/vp_adler_weiss_internal_construction.py`.
