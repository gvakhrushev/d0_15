...
exact_missing_primitive that appears in external_primitives.csv; every map row whose claim_id is a real
...
V = ROOT / "02_REGISTRY/frontier"
MAP = V / "research_closure_map.csv"
PRIMS = V / "external_primitives.csv"
