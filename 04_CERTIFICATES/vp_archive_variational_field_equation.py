...
NO_GO = output_path(__file__, "NO_GO_ARCHIVE_VARIATIONAL_FIELD_EQUATION.md")
    ...
    NO_GO.write_text(
        "\n".join(
            [
                ...
                "",
                "Generated by `04_CERTIFICATES/vp_archive_variational_field_equation.py`.",
                "",
...
def cleanup_stale_no_go() -> None:
    ...
    if "Generated by `04_CERTIFICATES/vp_archive_variational_field_equation.py`." in text:
        NO_GO.unlink()
