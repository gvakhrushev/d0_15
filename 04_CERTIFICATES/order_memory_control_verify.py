...
paths = [
    ...
    "03_FORMALIZATION/D0/Representation/OrderMemoryControl.lean",
...
output_path(__file__, "control_verification.json").write_text(json.dumps(result, ensure_ascii=False, indent=2)+"\n")
