...
nonzero solution would DERIVE the Higgs VEV. No such EOM exists in the registry or in 04_CERTIFICATES.
...
def main() -> int:
    ...
    print("MISSING_ARTIFACT  the macroscopic V13 phason-condensation EOM / order-parameter FIELD EQUATION: "
          ...
          "registry or 04_CERTIFICATES. Without it the Higgs VEV is NOT derived, only posited.")
