...
def regrows():
    rs = list(csv.reader((ROOT/"02_REGISTRY/claims.csv").open(encoding="utf-8", newline="")))
    return rs, rs[0]
def books():
...
def main() -> int:
    ...
    mods = list((ROOT/"03_FORMALIZATION/D0/Extensions").glob("*.lean"))
    ...
    e3 = (ROOT/"04_CERTIFICATES/vp_postcore_e3_archive_coordinate.py").read_text(encoding="utf-8")
