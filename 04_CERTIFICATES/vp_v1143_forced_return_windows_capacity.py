...
if __name__ == "__main__":
    ...
    output_path(__file__, "vp_v1143_forced_return_windows_capacity_results.json").write_text(json.dumps(out, indent=2), encoding="utf-8")
    ...
    md.append("")
    output_path(__file__, "vp_v1143_forced_return_windows_capacity.md").write_text("\n".join(md), encoding="utf-8")
    print(out["status"])
