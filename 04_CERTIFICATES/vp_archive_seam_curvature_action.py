...
NO_GO = output_path(__file__, "NO_GO_ARCHIVE_SEAM_CURVATURE_ACTION.md")
    ...
    NO_GO.write_text(
        "\n".join(
            [
                ...
                "",
                "Generated by `04_CERTIFICATES/vp_archive_seam_curvature_action.py`.",
                "",
...
def cleanup_stale_no_go() -> None:
    ...
    if "Generated by `04_CERTIFICATES/vp_archive_seam_curvature_action.py`." in text:
        NO_GO.unlink()
