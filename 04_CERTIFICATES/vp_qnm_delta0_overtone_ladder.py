...
until two preregistered artifacts exist AND validate against the frozen schema:
  * 04_CERTIFICATES/data/qnm_delta0_model.json   (the frozen, pre-data ladder model)
  * 04_CERTIFICATES/data/qnm_extracted_modes.csv (the extracted QNM mode table)
...
DATA_DIR = ROOT / "04_CERTIFICATES" / "data"
MODEL_FILE = DATA_DIR / "qnm_delta0_model.json"
MODES_FILE = DATA_DIR / "qnm_extracted_modes.csv"
NO_GO = output_path(__file__, "NO_GO_QNM_DELTA0_OVERTONE_LADDER.md")
