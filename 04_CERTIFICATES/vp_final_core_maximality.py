...
core_completion_inventory.csv is registered in 02_REGISTRY/claims.csv with the stated release_status
...
INV = ROOT / "02_REGISTRY/frontier" / "core_completion_inventory.csv"
