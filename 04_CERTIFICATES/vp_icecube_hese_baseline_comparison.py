...
================  PRE-REGISTRATION  (per 05_EXPERIMENTS/IceCube/icecube_baseline_protocol.md)
...
PASSPORT_DIR = ROOT / "05_EXPERIMENTS" / "IceCube"
...
def main() -> int:
    ...
    out = output_path(__file__, Path(__file__).with_suffix(".results.json").name)
