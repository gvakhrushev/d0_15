...
MANIFEST = ROOT / "05_EXPERIMENTS" / "CriticalCollapseDSS" / "dss_prl2026_manifest.json"
...
def run_certificate() -> int:
    ...
    (output_path(__file__, Path(__file__).with_suffix(".results.json").name)).write_text(json.dumps(results, indent=2), encoding="utf-8")
