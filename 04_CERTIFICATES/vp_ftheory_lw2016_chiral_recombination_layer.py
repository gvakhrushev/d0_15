...
OUT_JSON = output_path(__file__, "D0_FTHEORY_LW2016_CHIRAL_RECOMBINATION_NUMBERS.json")
OUT_REPORT = output_path(__file__, "D0_FTHEORY_LW2016_CHIRAL_RECOMBINATION_RESULTS.md")
