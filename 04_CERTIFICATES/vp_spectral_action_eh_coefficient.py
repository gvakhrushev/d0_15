...
def write_heat_trace_outputs(report: dict) -> None:
    with output_path(__file__, "heat_trace_a0.csv").open("w", encoding="utf-8", newline="") as f:
    ...
    with output_path(__file__, "heat_trace_a2_proxy.csv").open("w", encoding="utf-8", newline="") as f:
    ...
    with output_path(__file__, "higher_curvature_bound_report.json").open("w", encoding="utf-8") as f:
        json.dump(
            {
...
def main() -> int:
    ...
    payload = {
        ...
        "generated_outputs": [
            ".build/cert_outputs/vp_spectral_action_eh_coefficient/heat_trace_a0.csv",
            ".build/cert_outputs/vp_spectral_action_eh_coefficient/heat_trace_a2_proxy.csv",
            ".build/cert_outputs/vp_spectral_action_eh_coefficient/higher_curvature_bound_report.json",
        ],
    }
