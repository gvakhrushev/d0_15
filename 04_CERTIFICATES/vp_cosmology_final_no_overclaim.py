...
affirmative over-claim is caught. The phrases are licensed only if cosmology_frontier.csv shows
...
BOOKS = ROOT / "01_BOOKS"
BLOCKERS = ROOT / "02_REGISTRY/frontier" / "cosmology_frontier.csv"
...
def main() -> int:
    ...
    print(f"PASS_FRONTIER_NONEMPTY  {len(blockers)} blockers named in cosmology_frontier.csv.")
