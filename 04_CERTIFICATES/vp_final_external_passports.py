...
02_REGISTRY/assumptions.csv or as a claim in 02_REGISTRY/claims.csv. This makes the closed-negative-internal
...
INV = ROOT / "02_REGISTRY/frontier" / "external_passports.csv"
REG = ROOT / "02_REGISTRY" / "claims.csv"
LEDGER = ROOT / "02_REGISTRY" / "assumptions.csv"
