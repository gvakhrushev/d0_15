...
NO_GO = output_path(__file__, "NO_GO_ARCHIVE_LAPLACIAN_RG_FLOW.md")
    ...
    NO_GO.write_text(
        "\n".join(
            [
                ...
                "",
                "Generated by `04_CERTIFICATES/vp_archive_laplacian_rg_flow.py`.",
                "",
...
def cleanup_stale_no_go() -> None:
    ...
    if "Generated by `04_CERTIFICATES/vp_archive_laplacian_rg_flow.py`." in text:
        NO_GO.unlink()
