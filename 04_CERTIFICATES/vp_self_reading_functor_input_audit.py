...
def main() -> int:
    ...
    inp=json.load((ROOT/"04_CERTIFICATES/data/self_reading_functor_inputs.json").open(encoding="utf-8"))
    ...
    M=list(csv.reader((ROOT/"04_CERTIFICATES/data/post_core_extension_dependence.csv").open(encoding="utf-8",newline="")))
