...
| EXPENSIVE | 1 | 1 | 1 | 0 | 3 | 2 / 3 |
| WORKER | 4 | 0 | 0 | 0 | 4 | 0 / 5 |
| **Total** | **5** | **3** | **1** | **0** | **9** | **4 / 10** |
...
| EXP-A4D-CLASSICAL-KINEMATIC-INTERFACE-PRESSURE | EXPENSIVE | IN_PROGRESS | CTRL-GRAVITY-DYNAMICS-CLOSURE | D0-AFFINE-CARTAN-PATH-CLOSURE-001 |
