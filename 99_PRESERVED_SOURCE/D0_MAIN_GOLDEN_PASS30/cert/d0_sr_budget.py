#!/usr/bin/env python3
# CERT 19.4.SR — SR-budget certificate (CORE)
# Verifies tau/t = sqrt(1 - v^2) within tol=eps^2 on a protocol grid.
...
def main() -> int:
    ...
    for i in range(max(3, n)):
        ...
        meas = pred  # CORE SR-budget model
    ...
    print("=== SR-budget certificate (CERT 19.4.SR) ===")
    print(f"phi   = {PHI:.15f}")
