...
- Protocol: `05_EXPERIMENTS/REDSHIFT_DRIFT/D0_RD_01_PROTOCOL.md`.
- Manifest: `05_EXPERIMENTS/REDSHIFT_DRIFT/d0_rd_01_manifest.json`.
- Measurements: `05_EXPERIMENTS/REDSHIFT_DRIFT/direct_redshift_drift_measurements.csv`.
- Verdict: `05_EXPERIMENTS/REDSHIFT_DRIFT/d0_rd_01_verdict.json`.
- Certificate: `04_CERTIFICATES/vp_d0_redshift_drift_direct.py`.
