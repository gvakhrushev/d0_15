...
paths = [
    "09_LEAN_FORMALIZATION/D0/Integration/V15/RawZone.lean",
    "09_LEAN_FORMALIZATION/D0/Representation/OrderMemoryReadout.lean",
    "09_LEAN_FORMALIZATION/D0/Representation/SourcePortPreparation.lean",
    "09_LEAN_FORMALIZATION/D0/Representation/PreparationMemoryBound.lean",
    "09_LEAN_FORMALIZATION/D0/Representation/PortFrameCovariance.lean",
]
...
(HERE/"source_verification.json").write_text(json.dumps(result,ensure_ascii=False,indent=2)+"\n")
